...
const sections: AdminGuideSection[] = [
  ...
  },
  {
    ...
    articles: [
      article("protein-drink-top10", "단백질 음료 추천 TOP 10", "ProteinLab DB 음료 107종 기준으로 프로틴 음료와 저당 RTD 상위 후보를 정리합니다.", "/guides/product-selection-comparison/protein-drink-top10", { emoji: "🥤", tags: ["단백질 음료", "프로틴 음료", "랭킹"] }),
      ...
      article("high-protein-40g-comparison", "단백질 음료 40g 이상 3종 비교", "45g으로 리뉴얼된 테이크핏 몬스터, 뉴케어 41g, 닥터유 40g을 고단백 기준으로 정리합니다.", "/guides/product-selection-comparison/high-protein-40g-comparison", { emoji: "🏋️", tags: ["45g", "고단백", "비교"] }),
