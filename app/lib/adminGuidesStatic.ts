...
const sections: AdminGuideSection[] = [
  ...
  },
  {
    ...
    articles: [
      article("protein-drink-top10", "단백질 음료 추천 TOP 10", "ProteinLab DB 음료 110종 기준으로 프로틴 음료와 저당 RTD 상위 후보를 정리합니다.", "/guides/product-selection-comparison/protein-drink-top10", { emoji: "🥤", tags: ["단백질 음료", "프로틴 음료", "랭킹"] }),
      ...
      article("protein-shake-guide", "단백질 쉐이크 추천 가이드", "간편 섭취형 단백질 쉐이크를 고를 때 먼저 볼 기준을 정리합니다.", "/guides/product-selection-comparison/protein-shake-guide", { emoji: "🥤", tags: ["쉐이크", "선택"] }),
        ...
        article("shakebaby-protein-shake", "쉐이크베이비 단백질 쉐이크 추천", "초코, 딸기, 말차, 곡물, 스윗콘 플레이크 5종을 단백질·당류·칼로리 기준으로 비교한 브랜드 가이드입니다.", "/guides/product-selection-comparison/shakebaby-protein-shake", { emoji: "🍫", tags: ["쉐이크베이비", "쉐이크", "브랜드"] }),
        article("shakebaby-vs-danbaekhani", "쉐이크베이비 vs 단백하니", "맛 다양성과 칼로리 효율 기준으로 두 쉐이크 브랜드를 직접 비교합니다.", "/guides/product-selection-comparison/shakebaby-vs-danbaekhani", { emoji: "⚖️", tags: ["쉐이크", "비교", "브랜드"] }),
      ...
      article("low-sugar-protein-products-guide", "저당 단백질 제품 추천", "저당 기준으로 음료, 쉐이크, 요거트, 바 중 어떤 카테고리부터 보면 좋을지 정리합니다.", "/guides/product-selection-comparison/low-sugar-protein-products-guide", { emoji: "🍃", tags: ["저당", "카테고리", "다이어트"] }),
      article("protein-shake-top7", "단백질 쉐이크 추천 TOP 7", "ProteinLab DB 쉐이크 88개 기준으로 프로틴 쉐이크와 식사대용 후보를 정리합니다.", "/guides/product-selection-comparison/protein-shake-top7", { emoji: "🥇", tags: ["쉐이크", "프로틴 쉐이크", "다이어트"] }),
      article("labnosh-lineup", "랩노쉬 제품 종류 전체 정리", "슬림쉐이크 라인업과 52g 초고함량 출시 준비 이슈까지 함께 정리합니다.", "/guides/product-selection-comparison/labnosh-lineup", { emoji: "🎒", tags: ["랩노쉬", "52g", "쉐이크"] }),
      ...
      article("protein-bar-top10", "단백질 바 추천 TOP 10", "ProteinLab DB 바 100개 기준으로 프로틴바와 다이어트 간식 후보를 정리합니다.", "/guides/product-selection-comparison/protein-bar-top10", { emoji: "🍫", tags: ["단백질 바", "프로틴바", "랭킹"] }),
      ...
      article("protein-yogurt-top5", "단백질 요거트 추천 TOP 5", "ProteinLab DB 요거트 57개 기준으로 프로틴 요거트와 단백질 요거트 후보를 정리합니다.", "/guides/product-selection-comparison/protein-yogurt-top5", { emoji: "🥣", tags: ["요거트", "프로틴 요거트", "랭킹"] }),
      ...
      article("morning-protein-products-guide", "아침 대용 단백질 제품 추천", "아침 루틴 기준으로 포만감, 준비 시간, 보관 편의성까지 같이 보고 카테고리를 고르는 허브입니다.", "/guides/product-selection-comparison/morning-protein-products-guide", { emoji: "🌅", tags: ["아침", "카테고리", "식사대용"] }),
      article("oliveyoung-protein-products-guide", "올리브영 단백질 제품 추천", "올리브영에서 단품 테스트하기 좋은 제품을 쉐이크 중심으로 정리한 채널형 허브입니다.", "/guides/product-selection-comparison/oliveyoung-protein-products-guide", { emoji: "🛍️", tags: ["올리브영", "채널", "입문"] }),
      ...
      article("high-protein-40g-comparison", "단백질 음료 40g 이상 비교", "테이크핏 몬스터 딸기맛 47g, 뉴케어 41g, 닥터유 40g과 랩노쉬 52g 흐름을 고단백 기준으로 정리합니다.", "/guides/product-selection-comparison/high-protein-40g-comparison", { emoji: "🏋️", tags: ["47g", "52g", "고단백"] }),
      ...
      article("doctoru-40g-vs-takefit-monster-43g", "닥터유 40g vs 테이크핏 몬스터 47g", "40g급 고단백 RTD 2종을 맛과 영양 기준으로 직접 비교합니다.", "/guides/product-selection-comparison/doctoru-40g-vs-takefit-monster-43g", { emoji: "🥤", tags: ["47g", "고단백", "2자 비교"] }),
  ...
  },
  {
    ...
    articles: [
      ...
      article("protein-drink-trend-2026", "2026 단백질 음료 시장 트렌드", "테이크핏 몬스터 딸기맛 47g 리뉴얼과 랩노쉬 52g 출시 준비까지 초고단백 경쟁 흐름을 정리합니다.", "/guides/market-insights/protein-drink-trend-2026", { emoji: "📈", tags: ["2026", "47g", "52g"] }),
