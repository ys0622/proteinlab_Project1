...
const sections: AdminGuideSection[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      article("high-protein-40g-comparison", "단백질 음료 40g 이상 비교", "테이크핏 몬스터 45g, 뉴케어 41g, 닥터유 40g과 랩노쉬 52g 흐름을 고단백 기준으로 정리합니다.", "/guides/product-selection-comparison/high-protein-40g-comparison", { emoji: "🏋️", tags: ["45g", "52g", "고단백"] }),
      ...
      article("doctoru-40g-vs-takefit-monster-43g", "닥터유 40g vs 테이크핏 몬스터 45g", "40g급 고단백 RTD 2종을 맛과 영양 기준으로 직접 비교합니다.", "/guides/product-selection-comparison/doctoru-40g-vs-takefit-monster-43g", { emoji: "🥤", tags: ["45g", "고단백", "2자 비교"] }),
