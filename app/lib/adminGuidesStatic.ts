...
const sections: AdminGuideSection[] = [
  {
    ...
    emoji: "🧬",
    title: "단백질 기초",
    description: "단백질의 역할, 권장 섭취량, 부족 신호까지 Track A 전체 흐름을 관리합니다.",
    trackLabel: "TRACK A",
    accentColor: "#2d6a4f",
    accentBg: "#e7f3ec",
    previewHref: "/guides/protein-basics",
    articles: [
      article("protein-functions", "단백질 역할 개요", "단백질이 근육, 면역, 호르몬, 회복에 어떻게 연결되는지 설명합니다.", "/guides/protein-basics/protein-functions", { emoji: "🧠", tags: ["기초", "역할"] }),
      ...
      article("deficiency-symptoms", "단백질 부족 신호", "피로, 근육 감소, 부종 등 부족 시그널을 정리합니다.", "/guides/basics/deficiency-symptoms", { emoji: "⚠️", tags: ["결핍", "증상"] }),
      ...
      article("role-overview", "단백질 역할 개요 인포그래픽", "단백질의 역할을 시각적으로 한 번에 이해하는 페이지입니다.", "/guides/basics/role-overview", { emoji: "📊", tags: ["인포그래픽", "개요"] }),
    ],
  },
  {
    id: "track-b",
    ...
    emoji: "🔎",
    title: "제품 선택 · 비교",
    description: "단백질 음료와 바를 어떻게 비교하고 고를지 Track B 상세 페이지를 관리합니다.",
    trackLabel: "TRACK B",
    accentColor: "#4a6178",
    accentBg: "#eaf0f6",
    ...
    articles: [
      ...
      article("nutrition-comparison", "영양성분 비교", "단백질, 당류, 칼로리, 밀도를 어떻게 읽을지 설명합니다.", "/guides/product-selection-comparison/nutrition-comparison", { emoji: "📋", tags: ["비교", "영양성분"] }),
      article("nutrition-criteria", "영양성분 기준", "좋은 제품을 고를 때 참고할 최소 기준을 모아둡니다.", "/guides/product-selection-comparison/nutrition-criteria", { emoji: "📐", tags: ["기준", "체크리스트"] }),
      article("recommendation-lists", "추천 리스트 활용법", "추천, 큐레이션, picks의 차이와 활용법을 설명합니다.", "/guides/product-selection-comparison/recommendation-lists", { emoji: "🧭", tags: ["추천", "리스트"] }),
      article("ranking-content", "등급 · 랭킹 읽는 법", "등급, 랭킹, 100점 점수를 해석하는 기준을 정리합니다.", "/guides/product-selection-comparison/ranking-content", { emoji: "🏆", tags: ["랭킹", "등급"] }),
    ],
  },
  {
    id: "track-c",
    ...
    emoji: "⏱️",
    title: "섭취 전략 · 건강",
    description: "운동 전후, 체중 관리, 식사대용, 노년 단백질 전략까지 Track C를 관리합니다.",
    trackLabel: "TRACK C",
    accentColor: "#7a5230",
    accentBg: "#f5f0ea",
    ...
    articles: [
      ...
      article("muscle-maintenance-protein", "근육 유지 전략", "감량기와 병행 운동 상황에서 근육을 유지하는 전략을 설명합니다.", "/guides/intake-strategy-health/muscle-maintenance-protein", { emoji: "🧱", tags: ["근육 유지", "감량기"] }),
  ...
  },
  {
    ...
    emoji: "🏃",
    title: "운동 · 라이프스타일",
    description: "러닝, 마라톤, 근력운동, 운동 초보 가이드까지 Track D의 실제 콘텐츠를 관리합니다.",
    trackLabel: "TRACK D",
    accentColor: "#8a4b2f",
    accentBg: "#f8ede7",
    ...
    articles: [
      ...
      article("marathon-distance-strategy", "거리별 영양 및 훈련 전략", "5km, 10km, 하프, 풀 마라톤 전략을 비교합니다.", "/guides/fitness-lifestyle/marathon-distance-strategy", { emoji: "📍", tags: ["거리별", "전략"] }),
  ...
  },
  {
    ...
    emoji: "📈",
    title: "시장 인사이트",
    description: "RTD 시장, 브랜드 전략, 성분 트렌드 등 Track E 전체를 관리합니다.",
    trackLabel: "TRACK E",
    accentColor: "#6b4d7c",
    accentBg: "#f1ebf7",
    ...
    articles: [
      ...
      article("brand-analysis", "브랜드 분석", "주요 브랜드의 포지셔닝과 SKU 구성을 비교합니다.", "/guides/market-insights/brand-analysis", { emoji: "🏷️", tags: ["브랜드", "분석"] }),
      article("ingredient-trends", "성분 트렌드", "고단백, 저당, 워터형, 식물성 같은 키워드를 정리합니다.", "/guides/market-insights/ingredient-trends", { emoji: "🧪", tags: ["트렌드", "성분"] }),
      article("new-product-analysis", "신제품 분석", "새로 나온 제품을 어떤 기준으로 읽어야 할지 설명합니다.", "/guides/market-insights/new-product-analysis", { emoji: "✨", tags: ["신제품", "분석"] }),
      article("global-protein-market", "글로벌 단백질 시장", "해외 시장 흐름을 국내 제품 이해와 연결합니다.", "/guides/market-insights/global-protein-market", { emoji: "🌍", tags: ["글로벌", "시장"] }),
    ],
  },
  {
    id: "track-f",
    ...
    note: "현재는 일부 도구만 실제 페이지가 있고, 나머지는 계획 상태입니다.",
    trackLabel: "TRACK F",
    accentColor: "#5d4b8a",
    accentBg: "#efe9fb",
    ...
    articles: [
      ...
      article("protein-density-calculator", "단백질 밀도 계산기", "칼로리 대비 단백질 효율을 계산하는 도구입니다.", "/guides/tools", { emoji: "📊", tags: ["도구", "예정"], status: "planned" }),
    ],
  },
];
...
export function buildAdminGuidesStaticData(): AdminGuidesStaticData {
  return {
    mainPage: {
      title: "단백질 가이드",
      description: "Track A부터 Track F까지 현재 사이트에 연결된 가이드 구조를 관리자 관점에서 한 번에 관리합니다.",
