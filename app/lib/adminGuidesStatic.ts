...
const sections: AdminGuideSection[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      article("low-sugar-protein-products-guide", "저당 단백질 제품 추천", "음료, 쉐이크, 요거트, 바를 한 번에 비교하면서 저당 기준으로 어떤 카테고리가 맞는지 정리합니다.", "/guides/product-selection-comparison/low-sugar-protein-products-guide", { emoji: "🍃", tags: ["저당", "카테고리", "다이어트"] }),
      ...
      article("oliveyoung-protein-products-guide", "올리브영 단백질 제품 추천", "올리브영에서 접근하기 쉬운 단백질 제품을 쉐이크 중심으로 바와 요거트까지 함께 정리합니다.", "/guides/product-selection-comparison/oliveyoung-protein-products-guide", { emoji: "🛍️", tags: ["올리브영", "채널", "입문"] }),
