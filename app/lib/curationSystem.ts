...
const curations: CurationDefinition[] = [
  ...
  {
    id: "drink-low-calorie",
    slug: "drink-low-calorie",
    label: "저칼로리",
    icon: "🥗",
    kind: "ingredient",
    categoryTargets: ["drink"],
    ...
    categories: {
      drink: {
        ...
        quickIcon: "🥗",
        quickOrder: 100,
        filter: (product) => product.productType === "drink" && (product.calories ?? 999) <= 100,
        recommend: (products) => products.filter((product) => (product.calories ?? 999) <= 100),
      },
    },
  },
  {
