...
export default function HeroSection() {
  return (
    <section
      ...
      aria-label="히어로"
    >
      <div className="mx-auto max-w-[1200px] px-4 pb-2 pt-1 md:px-6 md:py-4">
        <div className="flex items-baseline gap-1.5 md:block">
          ...
          <p
            className="shrink-0 text-[10px] leading-none text-[var(--foreground-muted)] md:mt-1 md:text-sm md:leading-normal"
