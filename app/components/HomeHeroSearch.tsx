  ...
  return (
    <div className="flex flex-row items-center gap-2">
      <form
        ...
        className="flex h-10 min-w-0 flex-1 items-center gap-1.5 rounded-[9px] border bg-white pl-3 pr-1 shadow-sm md:h-14 md:gap-2 md:rounded-[12px] md:pl-5 md:pr-1.5"
      ...
      >
        ...
        <button
          type="submit"
          aria-label="검색"
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[8px] text-white transition-colors hover:opacity-90 md:h-11 md:w-11"
      ...
      <HomeTrackedLink
        ...
        className="flex h-10 shrink-0 items-center justify-center rounded-[9px] border px-3 text-[12px] font-bold whitespace-nowrap transition-colors hover:bg-[#EBF3ED] md:h-14 md:rounded-[12px] md:px-6 md:text-[14px]"
