...
export default function ProductCard({
  ...
  const imageArea = (
    <div
      className="product-card__media flex h-[180px] w-full flex-shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[#eee] bg-[#ffffff] p-1.5 transition-colors duration-200 group-hover:border-[#e2e2e2] md:h-[200px] md:p-[10px]"
      style={{ borderRadius: "12px" }}
    >
      {imageUrl ? (
        <div
          className="product-card__image relative h-full w-full max-w-[184px] md:max-w-[200px]"
        ...
        <div className="h-[144px] w-full max-w-[184px] md:h-[160px] md:max-w-[200px]" />
      )}
    </div>
  );
  ...
  return (
    <article
      className={`product-card group flex h-full flex-col overflow-hidden rounded-2xl border bg-[#FFFDF8] p-3 transition-all duration-200 ease-out hover:border-[#ddd] focus:outline-none focus:ring-2 focus:ring-[var(--accent)] focus:ring-offset-2 active:shadow-sm md:p-[14px] ${canOpenDetail ? "cursor-pointer" : ""}`}
    ...
    >
      ...
      <div className="product-card__content flex min-h-0 flex-1 flex-col">
        <p className="product-card__brand mt-3 text-xs tracking-wide md:mt-4" style={{ color: "#7a7a7a" }}>
          {brand}
        </p>
        ...
        <MetricBadgeGroup className="product-card__badges mt-1">
        ...
        <div className="mx-1 mt-2 border-t border-[#e8e6e3] md:mt-3" />

        <div className="product-card__metrics mt-2 grid grid-cols-2 gap-1.5 md:mt-3 md:gap-2">
          {[
            ...
            <div
              key={label}
              className="product-card__metric flex min-w-0 flex-col justify-center rounded-lg border border-[#e8e8e8] bg-white px-2 py-1.5 text-left md:px-2.5 md:py-2"
        ...
        <div className="cta-group mt-3 md:mt-4">
          <PurchaseLinkRow
        ...
        <div className="product-card__footer-actions mt-2 flex gap-2 md:mt-3 md:gap-3">
          <Link
            href={detailHref}
