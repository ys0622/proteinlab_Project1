...
export default function ProductCard({
  ...
  const imageArea = (
    <div
      className="product-card__media flex h-[184px] w-full flex-shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[#eee] bg-[#ffffff] p-1.5 transition-colors duration-200 group-hover:border-[#e2e2e2] md:h-[200px] md:p-[10px]"
  ...
  return (
    ...
    >
      ...
      <div className="product-card__content flex min-h-0 flex-1 flex-col">
        ...
        <div className="cta-group mt-2.5 md:mt-4">
          <PurchaseLinkRow
        ...
        <div className="product-card__footer-actions mt-2 flex gap-2.5 md:mt-3 md:gap-3">
          <Link
            href={detailHref}
            ...
            style={{ height: "38px", fontSize: "12px", borderRadius: "10px" }}
          >
            상세보기
          </Link>
          {slug ? (
