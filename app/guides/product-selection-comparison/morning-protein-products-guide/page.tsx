...
const config: CategoryGuideConfig = {
  ...
  title: "아침 대용 단백질 추천 | 출근 전 바로 고르는 음료·쉐이크·요거트·바",
  description:
    "바쁜 아침에 먹기 좋은 단백질 제품을 음료, 쉐이크, 요거트, 바 기준으로 비교합니다. 출근 전 3분, 포만감, 칼로리, 휴대성 기준으로 무엇부터 봐야 하는지 바로 정리했습니다.",
  keywords: [
    "아침 대용 단백질",
    "아침 단백질 추천",
    "아침 식사 대용 단백질",
  ...
  intro:
    "아침 대용 단백질을 찾는다면 제품 하나부터 고르기보다 먼저 카테고리를 정하는 편이 가장 빠릅니다. 출근 전 3분 안에 끝내야 하면 RTD 음료, 점심 전까지 버텨야 하면 쉐이크, 가볍게 시작하려면 요거트, 이동 중 한 손으로 끝내려면 바가 더 잘 맞습니다. 이 페이지는 바쁜 아침 루틴에 맞는 시작 카테고리를 먼저 정리해 시행착오를 줄여줍니다.",
  summary: [
    "출근 전 3분이면 RTD 음료, 점심 전까지 버텨야 하면 쉐이크, 가볍게 시작하려면 요거트, 이동 중이면 바부터 보면 됩니다.",
    "아침 대용은 단백질 g보다 포만감과 보관 편의성이 더 중요해서 숫자만 보면 오히려 루틴이 오래가기 어렵습니다.",
    "처음 시작하는 사람은 요거트나 무난한 맛 쉐이크처럼 진입 장벽이 낮은 후보부터 보는 편이 가장 안정적입니다.",
  ],
