...
const config: CategoryGuideConfig = {
  ...
  intro:
    "아침에는 영양보다도 먼저 현실성이 중요합니다. 출근 전 3분 안에 끝내야 하는지, 포만감이 점심 전까지 가야 하는지, 냉장 보관이 가능한지에 따라 맞는 카테고리가 달라집니다. 그래서 이 페이지는 제품 하나를 바로 추천하기보다 아침 대용으로 어떤 카테고리부터 보는 게 맞는지 먼저 정리합니다.",
  summary: [
    "시간이 가장 없으면 RTD 음료, 포만감이 중요하면 쉐이크, 가볍게 시작하려면 요거트, 이동 중 한 손으로 끝내려면 바가 유리합니다.",
    "아침 대용은 단백질 양만 보면 실패하기 쉽습니다. 칼로리, 당류, 식이섬유, 보관 편의성을 같이 봐야 실제로 오래 갑니다.",
    "처음 시작하는 사람은 바나 요거트처럼 부담이 적은 후보부터, 식사 대용 비중이 크면 쉐이크나 RTD 쪽으로 좁히는 편이 안정적입니다.",
  ],
