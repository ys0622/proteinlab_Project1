...
const config: CategoryGuideConfig = {
  ...
  title: "저칼로리 단백질 추천 | 다이어트용 음료·쉐이크·요거트·바 비교",
  description:
    "칼로리 낮은 단백질 제품을 찾는 사람을 위해 음료, 쉐이크, 요거트, 바를 한 번에 비교합니다. 다이어트, 아침 대용, 간식 목적에 맞는 시작 카테고리를 빠르게 고를 수 있게 정리했습니다.",
  keywords: [
    "저칼로리 단백질",
    "칼로리 낮은 단백질 제품",
    "다이어트 단백질 추천",
  ...
  summary: [
    ...
    "저칼로리는 칼로리만 낮다고 끝이 아니라 단백질과 당류, 실제 포만감까지 같이 봐야 다이어트 루틴이 안 무너집니다.",
    "결국 한 번 먹고 끝낼 제품보다 오래 유지할 수 있는 카테고리를 먼저 고르는 쪽이 실제 결과가 더 좋습니다.",
  ],
