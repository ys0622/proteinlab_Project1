...
const standards = [
  {
    title: "당류 컷을 먼저 정하기",
    body: "저당 단백질 음료를 찾는다면 가장 먼저 당류 기준을 정해야 합니다. 단백질이 높아도 당류가 높으면 검색 목적과 멀어질 수 있습니다.",
  },
  {
    title: "그다음 단백질",
  ...
  {
    title: "마지막은 칼로리와 밀도",
    body: "비슷한 저당 제품끼리 칼로리와 단백질 밀도를 비교해야 가볍게 마실지, 운동 후 보충형인지 구분할 수 있습니다.",
  },
];
...
const filterRows = [
  ...
  ["단백질 20g+", "기본 보충형 기준", "저당이면서도 보충용으로 볼 만한지 판단하기 쉽습니다."],
  ["단백질 밀도", "최종 비교용", "같은 칼로리 안에서 어떤 제품이 더 효율적인지 가를 수 있습니다."],
];
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            저당 단백질 음료는 단순히 단백질만 높은 제품이 아닙니다. 당류 기준 안에서 비교가 가능한 제품군을 먼저 정한 뒤 읽어야 합니다.
          </p>
        </div>
      </section>
