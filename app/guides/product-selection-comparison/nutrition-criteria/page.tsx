...
export const metadata = {
  ...
  description:
    "좋은 제품을 고를 때 참고할 단백질, 당류, 칼로리, 단백질 밀도 기준을 목적별로 정리합니다.",
};

const criteria = [
  ["단백질 음료", "20g 전후", "일반 보충과 회복용 비교를 시작하기 좋은 기본선입니다."],
  ["단백질 바", "10~20g", "간식형과 식사 보완형을 구분하는 기준으로 자주 쓰입니다."],
  ["당류", "가능하면 낮게", "체중 관리 목적이라면 다른 숫자보다 먼저 확인하는 편이 안전합니다."],
  ["단백질 밀도", "A~B 수준 우선", "열량 대비 단백질 효율을 빠르게 가르는 기준으로 유용합니다."],
];

const notes = [
  "기준은 절대값이라기보다 출발점에 가깝습니다.",
  "운동 후 보충, 체중 관리, 식사 보완처럼 목적에 따라 우선순위가 달라질 수 있습니다.",
  "같은 기준이라도 음료와 바는 섭취 맥락이 달라 해석을 구분해야 합니다.",
];
      ...
      <main className="mx-auto max-w-[1200px] px-4 py-8 md:px-6">
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            <h2 className="text-xl font-bold text-[var(--foreground)]">기준표와 함께 기억할 것</h2>
