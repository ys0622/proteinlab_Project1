...
export const metadata = {
  title: "영양성분 기준 세우기 | ProteinLab",
  description:
    "좋은 제품을 고를 때 참고하는 단백질, 당류, 칼로리, 단백질 밀도 기준을 목적별로 정리합니다.",
};

const criteria = [
  ["단백질 음료", "20g 전후", "일반 보충형과 고단백 제품을 구분하기 좋은 기본선입니다."],
  ["단백질 바", "10~20g", "간식형과 식사 보완형을 나누는 기준으로 자주 쓰입니다."],
  ["당류", "가능한 한 낮게", "체중 관리 목적이라면 다른 숫자보다 먼저 확인해야 할 지표입니다."],
  ["단백질 밀도", "A~B 등급 우선", "같은 칼로리나 용량 안에서 효율을 가르는 기준으로 유용합니다."],
];

const notes = [
  "기준은 절대값이 아니라 출발점에 가깝습니다.",
  "운동 후 보충, 체중 관리, 식사 보완처럼 목적에 따라 우선순위는 달라집니다.",
  "같은 기준이라도 음료와 바, 요거트는 제품 맥락이 다르므로 해석을 구분해야 합니다.",
];
      ...
      >
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <h1 className="mt-3 text-2xl font-bold leading-tight text-[var(--foreground)] md:text-3xl">
            성분표는 최소 기준부터 세워야 비교가 쉬워집니다
          </h1>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            기준점이 없으면 숫자가 많아질수록 비교가 더 어려워집니다. 단백질, 당류, 칼로리, 단백질
            밀도에서 최소 컷을 정해 두면 필요한 제품만 빠르게 추릴 수 있습니다.
          </p>
        </div>
      </section>
