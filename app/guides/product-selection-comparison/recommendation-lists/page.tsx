...
const items = [
  ...
  ["Picks", "특정 기준으로 이미 정리된 리스트를 빠르게 참고하고 싶을 때"],
  ["비교 페이지", "여러 제품을 수치로 직접 비교해 최종 결정하고 싶을 때"],
];
...
const flow = [
  ...
  {
    title: "후보 고르기",
    body: "후보가 몇 개로 줄었다면 추천 결과를 보고 우선순위를 세우는 흐름이 적합합니다.",
  },
  {
    title: "직접 비교하기",
    body: "마지막 판단은 비교 페이지에서 숫자를 직접 나란히 보는 방식이 가장 명확합니다.",
  },
];
      ...
      >
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            추천, 큐레이션, Picks, 비교 페이지는 각각 쓰임이 다릅니다. 어떤 상황에서 무엇을 먼저
            봐야 하는지 알면 제품 탐색 속도가 훨씬 빨라집니다.
          </p>
        </div>
      </section>
