...
const principles = [
  ...
  {
    title: "단백질은 보완 기준",
    body: "식사대용이라도 단백질이 낮으면 의미가 약해집니다. 포만감과 함께 최소 단백질 기준을 같이 확인해야 합니다.",
  },
  {
    title: "당류는 과하지 않게",
    body: "식사대용이라고 해서 당류가 높아도 되는 것은 아닙니다. 포만감과 당류 균형을 함께 봐야 합니다.",
  },
];

const matrix = [
  ["칼로리", "중간 이상", "식사 보완형인지 가늠하는 첫 기준"],
  ["단백질", "12g 이상 우선", "보완형으로서 의미가 있는지 확인"],
  ["당류", "과하지 않은지 체크", "식사대용이어도 과한 당류는 분리"],
  ["식이섬유/포만감", "부가 체크", "장시간 버티는 데 참고"],
];
