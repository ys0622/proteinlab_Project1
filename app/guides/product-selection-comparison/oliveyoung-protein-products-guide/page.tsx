...
const config: CategoryGuideConfig = {
  ...
  title: "올리브영 단백질 제품 추천 | 쉐이크 중심으로 바·요거트까지 정리",
  description:
    "올리브영에서 접근하기 쉬운 단백질 제품을 찾는 사람을 위해 쉐이크 중심으로 바와 요거트 후보까지 함께 정리합니다. 처음 사보는 사람도 바로 고를 수 있게 채널 기준으로 비교했습니다.",
  keywords: [
    "올리브영 단백질 제품",
    "올리브영 프로틴 추천",
    "올리브영 단백질 쉐이크",
  ...
  intro:
    "올리브영에서 단백질 제품을 찾는 사람은 대개 두 가지를 원합니다. 처음이라 박스 구매보다 단품으로 가볍게 테스트하고 싶거나, 오늘 바로 살 수 있는 후보를 빨리 좁히고 싶은 경우입니다. 현재 올리브영 채널에서 가장 선택지가 넓은 카테고리는 쉐이크이고, 바와 요거트는 상대적으로 폭이 좁습니다. 이 페이지는 그 현실을 기준으로 가장 실용적인 시작점을 정리합니다.",
  summary: [
    "올리브영 채널은 현재 쉐이크 중심으로 보는 편이 가장 효율적입니다. 입문자, 다이어트, 아침 대용 수요와도 가장 잘 맞습니다.",
    "바와 요거트는 선택지 자체가 적거나 시즌·매장별 차이가 있어서 보조 후보로 보는 게 더 현실적입니다.",
    "처음이라면 올리브영에서 단품으로 맛을 확인하고, 정착 후에는 박스 구매 채널로 넘어가는 흐름이 가장 안정적입니다.",
  ],
