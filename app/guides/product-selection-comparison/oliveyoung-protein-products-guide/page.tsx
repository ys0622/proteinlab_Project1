...
const config: CategoryGuideConfig = {
  ...
  title: "올리브영 단백질 추천 | 처음 사기 좋은 쉐이크·바·요거트 비교",
  description:
    "올리브영에서 처음 사보기 좋은 단백질 제품을 쉐이크 중심으로 비교했습니다. 단품 테스트, 오프라인 픽업, 입문용 브랜드 후보까지 한 번에 빠르게 좁혀볼 수 있습니다.",
  keywords: [
    "올리브영 단백질 제품",
    "올리브영 프로틴 추천",
    "올리브영 단백질 쉐이크",
  ...
  intro:
    "올리브영 단백질 추천을 찾는 사람은 대체로 처음 한두 개를 테스트해 보려는 경우가 많습니다. 그래서 이 페이지는 단품 테스트와 오프라인 픽업에 가장 잘 맞는 제품군부터 빠르게 보게 구성했습니다. 지금 기준으로는 쉐이크부터 들어가는 흐름이 가장 효율적이고, 바와 요거트는 보조 후보로 같이 보는 편이 더 현실적입니다.",
  summary: [
    "올리브영에서는 지금도 쉐이크부터 보는 편이 가장 효율적이고 입문자, 다이어트, 아침 대용 수요와 가장 잘 맞습니다.",
    "바와 요거트는 같이 볼 수 있지만 선택지 폭이 좁아서 보조 후보로 두는 쪽이 더 현실적입니다.",
    "처음엔 올리브영 단품 테스트, 정착 후엔 온라인 박스 구매로 넘어가는 흐름이 가장 안정적입니다.",
  ],
