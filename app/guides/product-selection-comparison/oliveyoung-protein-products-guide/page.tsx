...
const config: CategoryGuideConfig = {
  ...
  description:
    "올리브영에서 접근하기 쉬운 단백질 제품을 찾는 사람을 위해 쉐이크 중심으로 바와 요거트 후보까지 함께 정리합니다. 처음 사보는 사람도 단품 테스트 기준으로 바로 고를 수 있게 채널 중심으로 비교했습니다.",
  keywords: [
    "올리브영 단백질 제품",
    "올리브영 프로틴 추천",
    "올리브영 단백질 쉐이크",
  ...
  intro:
    "올리브영에서 단백질 제품을 찾는다면 지금은 쉐이크부터 보는 게 가장 빠릅니다. 단품 테스트가 쉽고 선택지도 가장 넓기 때문입니다. 바와 요거트는 보조 후보로 함께 볼 수 있지만, 메인 비교는 쉐이크 중심으로 들어가는 쪽이 훨씬 효율적입니다. 이 페이지는 그 현실을 기준으로 가장 실용적인 시작점을 정리합니다.",
  summary: [
