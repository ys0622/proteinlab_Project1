...
export const proteinShakeForWomenConfig: CategoryGuideConfig = {
  ...
  title: "여성을 위한 단백질 쉐이크 추천 | 다이어트·아침대용 비교 2026",
  description:
    "여성용 단백질 쉐이크를 다이어트, 아침 대용, 체형 유지 기준으로 직접 비교했습니다. 맛, 칼로리, 포만감까지 같이 보고 입문용 후보를 빠르게 좁혀볼 수 있습니다.",
  ...
  intro:
    "여성용 단백질 쉐이크 검색은 운동 보충보다 다이어트, 아침 대용, 체형 유지에 더 가깝습니다. 그래서 이 페이지는 단백질 숫자 하나보다 맛, 칼로리, 포만감 균형이 좋은 제품을 먼저 추려서 처음 고르는 사람도 입문용 후보를 바로 좁혀볼 수 있게 정리했습니다.",
  summary: [
    "여성 타깃 쉐이크는 고단백 숫자보다 맛, 칼로리, 포만감의 균형이 더 중요합니다.",
    "랩노쉬는 맛과 식이섬유, 올더배러는 저당과 올리브영 접근성, 단백하니와 플라이밀은 브랜드별 맛 차이 정리가 더 선명합니다.",
    "처음 시작은 올리브영 단품 테스트, 그다음 브랜드 페이지로 좁히고 정착 후에는 쿠팡 박스 구매로 넘어가는 흐름이 가장 실용적입니다.",
  ],
...
export const morningProteinShakeConfig: CategoryGuideConfig = {
  ...
  title: "아침 식사 대용 단백질 쉐이크 | 출근 전 고르기 좋은 제품 비교",
  description:
    "바쁜 아침에 마시기 좋은 파우치형 단백질 쉐이크를 포만감, 칼로리, 식이섬유 기준으로 비교했습니다. 출근 전 루틴용 후보를 빠르게 좁히고 싶다면 이 페이지가 가장 직접적입니다.",
  ...
  intro:
    "아침용 쉐이크는 다이어트용 쉐이크와 기준이 조금 다릅니다. 가장 낮은 칼로리보다 공복에 부담이 적고 점심 전까지 버틸 수 있는지가 더 중요합니다. 그래서 이 페이지는 출근 전 루틴에서 실제로 오래 쓰기 쉬운 후보를 포만감과 루틴 지속성 중심으로 먼저 보여줍니다.",
  summary: [
    ...
    "아침 쉐이크는 한 끼를 완전히 대체한다기보다 굶는 대신 안정적으로 시작하는 보완재로 보는 편이 더 현실적이고, 브랜드 페이지까지 같이 보면 선택이 더 빨라집니다.",
  ],
