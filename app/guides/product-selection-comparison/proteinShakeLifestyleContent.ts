...
export const proteinShakeForWomenConfig: CategoryGuideConfig = {
  ...
  title: "여성을 위한 단백질 쉐이크 추천 | 다이어트·아침대용 기준",
  description:
    "여성용 단백질 쉐이크를 다이어트, 아침 대용, 체형 유지 기준으로 직접 비교했습니다. 맛, 칼로리, 포만감까지 같이 보고 고르고 싶다면 이 페이지가 가장 빠릅니다.",
  ...
  intro:
    "여성용 단백질 쉐이크 검색은 운동 보충보다 다이어트, 아침 대용, 체형 유지에 더 가깝습니다. 그래서 이 페이지는 단백질 숫자 하나보다 맛, 칼로리, 포만감 균형이 좋은 제품을 먼저 추려서 처음 고르는 사람도 바로 좁혀볼 수 있게 정리했습니다.",
  summary: [
