...
const categoryRows: CategoryMetricRow[] = [
  ...
  { label: "평균 단백질", values: ["20~45g", "20~27g", "10~25g", "10~15g"] },
...
export const proteinShakeTop7Config: CategoryGuideConfig = {
  ...
  summary: [
    ...
    "처음 시작이라면 순위에서 후보를 줄인 뒤 브랜드 페이지까지 한 단계 더 들어가 맛과 칼로리 차이를 확인하는 편이 가장 안전합니다.",
  ],
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "쉐이크베이비 신규 5종", body: "쉐이크베이비는 초코, 딸기, 말차, 곡물, 스윗콘 플레이크 5가지 맛으로 새로 등록됐습니다. 단백질 20~22g, 당류 2~3g대로 상위권과 큰 차이는 없어 맛 선택 폭을 넓히고 싶을 때 후보로 넣기 좋습니다." },
      ],
    },
  ],
    relatedGuides: [
...
export const labnoshLineupConfig: CategoryGuideConfig = {
  slug: "labnosh-lineup",
  title: "랩노쉬 슬림쉐이크 추천 | 52g 초고함량 출시 준비와 라인업 비교",
  description: "랩노쉬 슬림쉐이크 주요 맛을 식이섬유, 칼로리, 당류 기준으로 비교하고 52g 초고함량 제품 출시 준비 이슈까지 함께 정리했습니다.",
  keywords: ["랩노쉬 종류", "랩노쉬 라인업", "랩노쉬 슬림쉐이크", "랩노쉬 52g", "랩노쉬 초고함량"],
  badge: "브랜드 라인업",
  readingTime: "5분 읽기",
  updatedAt: "2026-03-24",
  methodologyNote: "ProteinLab DB 파우치형 랩노쉬 SKU 기준",
  intro: "랩노쉬를 찾는 사람은 보통 단백질 숫자 하나보다 맛있게 오래 먹을 수 있는 식사대용 쉐이크를 찾는 경우가 많습니다. 다만 52g 초고함량 제품 출시 준비 이슈가 생기면서, 기존 슬림쉐이크 라인업과 새 고함량 포지션을 구분해서 보는 것이 중요해졌습니다.",
  summary: [
    "현재 판매·등록된 랩노쉬 슬림쉐이크 강점은 극단적인 고단백보다 맛 만족도와 식사대용 지속성에 있습니다.",
    "52g 초고함량 제품은 출시 준비 단계로 보이며, 공개 스펙이 확정되면 기존 20g대 식사대용 라인과 별도 기준으로 비교해야 합니다.",
  ...
  sections: [
    {
      ...
      items: [
        ...
        { title: "3단계: 52g 제품은 별도 기준으로 보기", body: "52g 초고함량 제품은 기존 슬림쉐이크와 목적이 다를 가능성이 큽니다. 출시 후 단백질 총량뿐 아니라 칼로리, 당류, 포만감까지 다시 비교해야 합니다." },
      ],
    },
    {
      title: "목적별 추천",
    ...
    },
    {
      ...
      items: [
        ...
        { title: "실제 선택 포인트", body: "맛에 민감하고 꾸준함이 중요하면 기존 랩노쉬 슬림쉐이크가 유리합니다. 반대로 한 번에 단백질을 크게 채우려는 목적이라면 52g 신제품 스펙 공개 후 별도로 비교하는 편이 맞습니다." },
      ],
    },
    {
  ...
  faq: [
    ...
    { question: "랩노쉬 52g 제품은 기존 슬림쉐이크와 같은 기준으로 보면 되나", answer: "아직 공개 판매 전 단계라 단정하기 어렵습니다. 다만 52g은 기존 식사대용 슬림쉐이크보다 초고함량 보충형에 가까울 가능성이 있어, 출시 후 칼로리·당류·용량까지 별도 기준으로 비교하는 것이 안전합니다." },
  ],
};
