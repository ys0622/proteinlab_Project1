...
export const proteinCategoryGuideConfig: CategoryGuideConfig = {
  ...
  title: "단백질 음료 vs 쉐이크 vs 바 vs 요거트 | 초보는 뭐부터 먹을까",
  description: "단백질 음료, 쉐이크, 바, 요거트를 한눈에 비교했습니다. 운동 후, 다이어트, 아침 대용, 간식용 중 어떤 카테고리가 맞는지 초보 기준으로 바로 정리합니다.",
  keywords: ["단백질 음료 쉐이크 차이", "프로틴 뭐 먹어야 해", "단백질 보충제 종류", "단백질 카테고리 비교"],
  badge: "카테고리 허브",
  readingTime: "5분 읽기",
  updatedAt: "2026-03-24",
  methodologyNote: "ProteinLab DB 카테고리 구조 + 시중 가격대 기준",
  intro: "단백질 제품이 처음이면 브랜드보다 먼저 카테고리를 정하는 편이 훨씬 쉽습니다. 운동 후 한 병 바로 마실지, 아침 식사처럼 포만감 있게 먹을지, 간식처럼 들고 다닐지를 먼저 정하면 맞는 제품군이 거의 자동으로 좁혀집니다. 이 페이지는 그 첫 선택을 가장 빠르게 끝내기 위한 카테고리 허브입니다.",
  summary: [
    "운동 후 빠른 보충부터 고르려면 RTD 음료가 가장 단순하고 실패가 적습니다.",
    "아침 대용과 다이어트 포만감까지 같이 보면 파우치 쉐이크가 가장 강합니다.",
    "이동 중 간편 간식은 단백질 바, 덜 무거운 식사 보완은 단백질 요거트로 보면 정리가 빠릅니다.",
  ],
...
export const proteinShakeTop7Config: CategoryGuideConfig = {
  ...
  title: "단백질 쉐이크 추천 TOP 7 | 다이어트·식사대용 기준 2026",
  description: "ProteinLab DB 파우치형 단백질 쉐이크를 기준으로 다이어트, 식사 대용, 단백질 보충까지 두루 보기 좋은 TOP 7을 골랐습니다. 브랜드별 차이까지 빠르게 좁혀볼 수 있습니다.",
  keywords: ["단백질 쉐이크 추천", "다이어트 쉐이크 추천", "여성 단백질 쉐이크", "파우치 단백질 쉐이크"],
  badge: "쉐이크 랭킹",
  readingTime: "6분 읽기",
  updatedAt: "2026-03-24",
  methodologyNote: "ProteinLab DB 파우치형 쉐이크의 단백질·칼로리·당류·식이섬유 종합 점수",
  intro: "단백질 쉐이크 추천을 찾는 사람 대부분은 결국 다이어트, 아침 대용, 허기 관리 중 하나를 해결하려고 들어옵니다. 그래서 파우치형 쉐이크는 단백질 숫자만 높다고 끝나는 게 아니라 칼로리, 당류, 식이섬유, 맛 지속성을 같이 봐야 실제로 오래 마시기 쉽습니다. 이 페이지에서 상위 후보를 먼저 좁힌 뒤 플라이밀, 단백하니, 프로티원 같은 브랜드 페이지로 다시 들어가면 선택 속도가 훨씬 빨라집니다.",
  summary: [
    "상위권은 단백질 20g 이상에 당류가 낮고 식이섬유까지 챙긴 제품들입니다.",
    "랩노쉬는 맛과 포만감, 프로티원은 저칼로리, 잇더핏은 고단백 효율이 강점이라 누구에게 맞는지가 분명히 갈립니다.",
    "처음 시작이라면 순위만 보고 끝내지 말고 브랜드 페이지까지 한 단계 더 들어가서 맛과 칼로리 차이를 확인하는 편이 안전합니다.",
  ],
...
export const labnoshLineupConfig: CategoryGuideConfig = {
  slug: "labnosh-lineup",
  title: "랩노쉬 슬림쉐이크 추천 | 맛·식사대용 기준 라인업 비교",
  description: "랩노쉬 슬림쉐이크 주요 맛을 식이섬유, 칼로리, 당류 기준으로 비교했습니다. 맛있게 오래 먹을 식사대용 쉐이크를 찾는다면 이 페이지가 가장 빠릅니다.",
  keywords: ["랩노쉬 종류", "랩노쉬 라인업", "랩노쉬 슬림쉐이크", "랩노쉬 올리브영"],
  badge: "브랜드 라인업",
  readingTime: "5분 읽기",
  updatedAt: "2026-03-24",
  methodologyNote: "ProteinLab DB 파우치형 랩노쉬 SKU 기준",
  intro: "랩노쉬를 찾는 사람은 보통 단백질 숫자 하나보다 맛있게 오래 먹을 수 있는 식사대용 쉐이크를 찾는 경우가 많습니다. 그래서 이 페이지는 고단백 순위보다 맛, 식이섬유, 칼로리 차이를 먼저 정리해 랩노쉬 안에서 무엇부터 고르면 좋은지 빠르게 판단하게 만드는 데 초점을 맞췄습니다.",
  summary: [
    "랩노쉬 강점은 극단적인 고단백보다 맛 만족도와 식사대용 지속성에 있습니다.",
    "대부분 20g 전후 단백질, 160~175kcal 구간이라 숫자보다 맛과 식이섬유 차이를 먼저 보는 편이 더 실용적입니다.",
    "첫 구매라면 더블초코, 얼그레이 밀크티, 제주말차 순서로 좁히는 방식이 가장 실패가 적습니다.",
  ],
...
export const dietProteinShakeConfig: CategoryGuideConfig = {
  ...
  title: "다이어트 단백질 쉐이크 추천 | 저칼로리·저당 기준 2026",
  description: "다이어트용 단백질 쉐이크를 저칼로리, 저당, 단백질 20g 이상 기준으로 직접 비교했습니다. 살 빼면서 허기까지 줄이고 싶다면 이 페이지부터 보면 됩니다.",
  ...
  intro: "다이어트용 쉐이크를 찾을 때 가장 많이 하는 실수가 칼로리만 보고 고르는 것입니다. 실제로는 칼로리가 낮아도 단백질과 식이섬유가 부족하면 금방 허기가 오고, 당류가 높으면 체감 만족도도 떨어집니다. 그래서 이 페이지는 살 빼면서도 오래 버티기 쉬운 제품을 고르도록 칼로리, 당류, 단백질, 식이섬유를 함께 보게 구성했습니다.",
  summary: [
    "다이어트용 상위권은 110~170kcal 안에서 단백질 20g 이상을 확보한 제품들입니다.",
    "극저칼로리만 보면 프로티원, 포만감까지 같이 보면 랩노쉬, 맛과 저당 균형은 단백하니와 플라이밀 쪽이 더 선명합니다.",
    "하루 두 끼 이상 대체보다 아침 한 끼나 간식 대체용으로 쓰는 방식이 실제 유지에 더 안정적입니다.",
  ],
