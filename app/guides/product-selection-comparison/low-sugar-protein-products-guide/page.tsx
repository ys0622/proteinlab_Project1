...
const config: CategoryGuideConfig = {
  ...
  intro:
    "저당 제품을 찾는 이유는 다이어트만이 아닙니다. 혈당 관리가 필요하거나, 달지 않은 제품을 오래 마시고 싶거나, 야식 대신 가볍게 단백질을 보충하려는 경우도 많습니다. 이 페이지는 음료, 쉐이크, 요거트, 바를 한 번에 놓고 당류 기준으로 어떤 카테고리가 더 잘 맞는지 정리합니다.",
  summary: [
    "당류를 가장 깔끔하게 관리하려면 RTD 음료와 일부 쉐이크가 유리하고, 요거트와 바는 제품별 편차를 더 꼼꼼히 봐야 합니다.",
    "저당 제품을 고를 때는 당류만 보지 말고 단백질과 칼로리, 실제로 오래 먹을 수 있는 맛인지까지 같이 봐야 합니다.",
    "다이어트나 혈당 관리 목적이라면 달지 않은 맛에 적응하기 쉬운 카테고리부터 시작하는 쪽이 루틴 유지에 더 유리합니다.",
  ],
