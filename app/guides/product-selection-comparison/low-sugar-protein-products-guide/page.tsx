...
const config: CategoryGuideConfig = {
  ...
  intro:
    "저당 단백질 제품은 생각보다 카테고리 선택이 중요합니다. 당류를 가장 깔끔하게 관리하려면 RTD 음료나 일부 쉐이크가 유리하고, 요거트와 바는 제품별 편차를 더 꼼꼼히 봐야 합니다. 이 페이지는 음료, 쉐이크, 요거트, 바를 한 번에 놓고 당류 기준으로 어떤 카테고리가 더 잘 맞는지 정리합니다.",
  summary: [
    "당류 관리가 최우선이면 RTD 음료나 일부 쉐이크부터, 가벼운 간식이면 요거트, 이동 중이면 바를 보되 성분표를 더 꼼꼼히 확인해야 합니다.",
    "저당 제품은 당류 숫자만 보면 안 됩니다. 단백질과 칼로리, 계속 먹을 수 있는 맛인지까지 같이 봐야 실패가 줄어듭니다.",
    "다이어트나 혈당 관리 목적이라면 달지 않은 맛에 적응하기 쉬운 카테고리부터 시작하는 편이 더 오래 갑니다.",
  ],
