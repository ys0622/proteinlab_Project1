...
const checklistRows = [
  ["단백질 함량", "1병당 20g 전후인지 먼저 확인", "운동 후 보충인지 식사 보완인지 1차 판단이 갈립니다."],
  ["당류", "체중 관리 목적이면 가능한 한 먼저 체크", "단백질이 높아도 당류가 높으면 실제 사용 목적이 달라집니다."],
  ["칼로리", "식사 보완형인지 가벼운 보충형인지 구분", "칼로리가 낮으면 가벼운 보충, 높으면 식사 보완에 가깝습니다."],
  ["단백질 밀도", "비슷한 칼로리 안에서 최종 비교", "같은 양이라도 어떤 제품이 더 효율적인지 판단할 때 유용합니다."],
];
...
const drinkTypes = [
  ...
  {
    title: "워터형 RTD",
    body: "운동 중간이나 직후에 가볍게 마시기 좋습니다. 상대적으로 저칼로리 제품이 많아 체중 관리용 보충으로도 자주 쓰입니다.",
  },
  {
    title: "고단백 보충형",
    body: "30g 전후 고단백 제품은 운동 후 보충에 강점이 있지만 칼로리나 당류가 같이 높지 않은지 반드시 확인해야 합니다.",
  },
];
...
const comparisonSteps = [
  ...
  { title: "2차", body: "당류·칼로리 거르기", note: "체중 관리용인지 식사 보완형인지 구분" },
  { title: "3차", body: "단백질 함량 비교", note: "20g 전후, 30g 이상 등 목적별 기준 확인" },
  { title: "4차", body: "단백질 밀도 확인", note: "비슷한 칼로리라면 마지막 비교 포인트" },
];
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-white px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <blockquote className="mt-5 rounded-xl border border-[#dce8df] bg-[#f7fbf8] px-4 py-4 text-sm leading-6 text-[var(--foreground-muted)]">
              비교에서 중요한 것은 숫자 하나가 아니라 조합입니다. 단백질이 높아도 당류나 칼로리가 높으면 실제 용도는 달라질 수 있습니다.
            </blockquote>
          </section>
        </div>
      </main>
