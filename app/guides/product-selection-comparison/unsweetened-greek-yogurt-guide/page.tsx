...
export const metadata = {
  ...
  description:
    "무가당 그릭요거트를 고를 때 당류, 단백질 밀도, 칼로리, 용량 기준을 어떻게 봐야 하는지 ProteinLab 기준으로 정리합니다.",
};

const rules = [
  {
    title: "무가당 여부 먼저",
    body: "플레인처럼 보여도 실제로는 저당 또는 가당인 경우가 있어 당류 표기와 제품명을 함께 확인해야 합니다.",
  },
  {
    title: "그릭은 밀도가 핵심",
    body: "무가당 그릭요거트는 단백질 g보다 100g당 단백질 밀도를 같이 봐야 진짜 꾸덕한 고단백 제품을 가리기 쉽습니다.",
  },
  {
    title: "대용량은 1회 기준 병행",
    body: "450g, 800g 같은 대용량은 총량보다 1회 섭취 기준과 100g 기준을 같이 봐야 비교 오류가 줄어듭니다.",
  },
];

const compareRows = [
  ["당류", "0~5g 구간 우선", "무가당 여부 판단의 출발점"],
  ["단백질 밀도", "100g당 수치 비교", "그릭 제품군 압축에 가장 유용"],
  ["칼로리", "밀도와 같이 보기", "밀도는 높아도 열량이 과한 제품은 따로 분리"],
  ["용량", "100g 기준 병행", "대용량 착시를 줄이는 핵심"],
];
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            무가당 그릭요거트는 플레인, 저당, 대용량 제품이 섞여 있어 제품명만으로는 비교가 끝나지 않습니다.
            <br />
            당류, 100g당 단백질 밀도, 칼로리, 용량 기준을 함께 보는 흐름을 정리했습니다.
          </p>
        </div>
      </section>
