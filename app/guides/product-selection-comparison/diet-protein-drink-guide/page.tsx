...
const criteriaCards = [
  {
    title: "1. 당류를 먼저 본다",
    body: "체중 관리 목적이라면 단백질 g만 보기보다 당류 컷을 먼저 걸러야 합니다. 같은 20g 제품이라도 당류 차이로 활용도는 크게 달라집니다.",
  },
  {
    title: "2. 칼로리와 포만감을 함께 본다",
    body: "너무 가벼우면 간식형에 가깝고, 너무 무거우면 식사 보완형에 가깝습니다. 다이어트용은 그 균형이 중요합니다.",
  },
  {
    title: "3. 마지막에 단백질 밀도를 본다",
    body: "후보를 추린 뒤에는 100kcal당 단백질 효율까지 보면 같은 칼로리 안에서 더 실용적인 제품을 고르기 쉽습니다.",
  },
];
...
const thresholdBars = [
  ...
  { label: "밀도 컷", value: "100kcal당 단백질 비교", width: "72%" },
];

const flowCards = [
  {
    title: "체중 관리용",
    body: "당류와 칼로리를 먼저 좁힌 뒤 그 안에서 단백질 밀도와 단백질 총량을 비교하는 흐름이 가장 안정적입니다.",
  },
  {
    title: "식사 보완형",
    body: "칼로리와 포만감이 먼저입니다. 당류가 과하지 않은지 확인한 뒤 단백질이 충분한지 보면 됩니다.",
  },
  {
    title: "이동 중 가볍게",
    body: "당류가 과하지 않으면서 단백질 밀도가 괜찮은 제품이 적합합니다. 너무 무거우면 식사 대체형 목적에 더 가깝습니다.",
  },
];
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-white px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <blockquote className="mt-5 rounded-xl border border-[#dce8df] bg-[#f7fbf8] px-4 py-4 text-sm leading-6 text-[var(--foreground-muted)]">
              다이어트용 단백질 음료는 고단백과 저칼로리만으로 끝나지 않습니다. 너무 가벼우면
              포만감이 약하고, 너무 무거우면 식사 보완형에 가까워집니다.
            </blockquote>
          </section>
        </div>
      </main>
