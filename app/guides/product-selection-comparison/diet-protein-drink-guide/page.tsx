...
export const metadata = {
  title: "다이어트 단백질 음료 기준 | 저당·저칼로리·밀도 비교 | ProteinLab",
  description:
...
const criteriaCards = [
  ...
  },
  {
    ...
    body: "너무 가벼우면 간식형에 가깝고, 너무 높으면 식사 보완형에 가까워집니다. 다이어트용은 그 균형이 중요합니다.",
  },
  {
    title: "3. 마지막이 단백질 밀도다",
    body: "후보를 추린 뒤에는 100kcal당 단백질 효율을 보면 같은 칼로리 안에서 더 실용적인 제품을 고르기 쉽습니다.",
  },
];

const checklistRows = [
  ["당류", "가능한 한 먼저 확인", "다이어트 목적이라면 당류가 낮은 제품부터 좁히는 편이 실제 선택과 가깝습니다."],
  ["칼로리", "식사 보완형인지 간식형인지 구분", "칼로리와 포만감을 같이 봐야 맥락을 읽을 수 있습니다."],
...
const flowCards = [
  ...
  {
    title: "운동 후 가볍게",
    body: "당류가 과하지 않으면서 단백질 밀도가 괜찮은 제품을 고릅니다. 너무 무거우면 식사 대체형과 목적이 섞입니다.",
  },
];
