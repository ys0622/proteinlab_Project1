...
export const proteinDrinkTop10Config: CategoryGuideConfig = {
  ...
  title: "단백질 음료 추천 TOP 10 | 47g·52g 초고단백 RTD까지 비교 2026",
  description:
    "2026년 ProteinLab DB 음료 133종을 기준으로 단백질 함량, 당류, 칼로리, 밀도를 비교해 단백질 음료·프로틴 음료 추천 TOP 10을 정리했습니다. 테이크핏 47g과 랩노쉬 52g 같은 초고단백 RTD도 함께 해석합니다.",
  keywords: ["단백질 음료 추천", "단백질 음료 TOP10", "프로틴 음료 추천", "RTD 단백질 음료", "저당 단백질 음료", "고단백 RTD", "단백질 음료 47g", "단백질 음료 52g"],
  badge: "음료 랭킹",
  readingTime: "6분 읽기",
  updatedAt: "2026-04-17",
  methodologyNote: "ProteinLab DB 음료 133종 기준 · 단백질/당류/칼로리/밀도 종합 + 동일 브랜드 최대 2개 반영",
  intro:
    "단백질 음료 추천을 찾는다면 1위만 보는 것보다 단백질 함량, 당류, 칼로리, 단백질 밀도를 함께 보는 편이 정확합니다. ProteinLab DB 음료 133종 중 단백질 20g 이상, 당류 8g 이하, 205kcal 이하 조건을 통과한 제품을 종합 점수화하고 테이크핏·더단백·이정후 프로틴·랩노쉬·뉴케어 등 브랜드별 2개까지만 반영했습니다.",
  summary: [
    "상위권은 단백질 25~47g, 당류 0~1.2g, 125~204kcal 구간에 몰려 있어 단백질 밀도와 칼로리 조합이 최종 판단 포인트입니다.",
    "테이크핏 47g, 더단백 40g, 이정후 프로틴 33g, 랩노쉬 퍼펙트 27g, 뉴케어 올프로틴 25g처럼 단백질 구간이 넓어 1위보다 자신의 용도에 맞는 구간 선택이 더 중요합니다.",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          body: `${[...new Set(highProteinDrinkPicks.map((p) => p.brand))].slice(0, 3).join(", ")}처럼 24g 이상 구간이 따로 있습니다. 최근에는 47g·52g 초고단백 제품까지 생겨 이 경우 40g 이상 비교나 고단백 브랜드 비교로 이어지는 편이 빠릅니다.`,
        },
        {
  ...
  relatedGuides: [
    ...
    },
    {
      ...
      description: "운동 직후 보충 목적이라면 47g·52g까지 포함한 초고단백 흐름을 같이 보는 편이 빠릅니다.",
    },
    {
      title: "단백질 밀도 순위 가이드",
  ...
  faq: [
    {
      ...
      answer: "아닙니다. 1위권 테이크핏 몬스터는 딸기맛 기준 단백질 47g의 고강도 보충형입니다. 가볍게 마시고 싶다면 뉴케어 올프로틴 25g이나 랩노쉬 퍼펙트처럼 칼로리가 낮은 제품이 더 맞습니다. 단백질 구간과 칼로리를 같이 보는 것이 먼저입니다.",
    },
    {
