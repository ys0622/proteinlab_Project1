...
const focusPoints = [
  {
    title: "항체와 사이토카인",
    body: "면역 반응을 움직이는 직접 재료가 단백질입니다. 부족하면 방어와 회복 속도가 함께 느려질 수 있습니다.",
  },
  {
    title: "호르몬의 구조",
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e8e6e3] bg-[#fffdf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-4 text-sm leading-6 text-[var(--foreground-muted)]">
              항체와 사이토카인처럼 병원체를 인식하고 면역 반응을 조절하는 물질은 단백질 기반입니다.
              단백질이 부족하면 면역세포 증식과 회복 속도도 영향을 받을 수 있습니다.
            </p>
          ...
          <section className="rounded-[28px] border border-[#e8e6e3] bg-[#fffdf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-4 text-sm leading-6 text-[var(--foreground-muted)]">
              인슐린, 성장호르몬 일부, 각종 소화 효소는 모두 단백질 구조를 기반으로 작동합니다. 그래서
              단백질 부족은 근육뿐 아니라 전신 조절에도 영향을 줍니다.
            </p>
