...
export const metadata = {
  title: "봄 야외활동 단백질 간식 가이드 | 소풍·산책·러닝 간식 기준 | ProteinLab",
  description:
    "봄철 소풍, 산책, 야외활동에서 챙기기 좋은 단백질 간식 기준을 휴대성, 당류, 포만감 중심으로 정리했습니다.",
};

const activityCards = [
  {
    title: "휴대성 우선",
    body: "봄철 야외활동은 실온 보관과 이동성이 중요합니다. 그래서 바, RTD, 드링킹 요거트처럼 바로 먹을 수 있는 형태가 유리합니다.",
  },
  {
    title: "당류는 과하지 않게",
    body: "야외활동 간식은 디저트형 제품으로 기울기 쉽습니다. 단백질 간식이라도 당류가 과한지 꼭 확인해야 합니다.",
  },
  {
    title: "포만감은 목적에 맞게",
    body: "가벼운 산책용인지, 반나절 외출용인지에 따라 필요한 포만감이 다릅니다. 간식형과 식사보완형을 구분해야 합니다.",
  },
];

const itemRows = [
  ["가벼운 산책", "드링킹 요거트 / RTD", "휴대성과 가벼운 포만감"],
  ["반나절 외출", "단백질 바", "실온 보관과 포만감"],
  ["러닝·운동 후", "RTD + 이후 식사", "즉시 회복과 다음 끼니 연결"],
];
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            소풍, 가벼운 산책, 야외 러닝처럼 봄철 활동이 늘어날수록 단백질 간식은 휴대성과 부담 없는 구성이 중요해집니다.
          </p>
        </div>
      </section>
