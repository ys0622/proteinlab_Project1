...
const liftCards = [
  ...
  {
    title: "주간 총량 유지",
    body: "근력운동이 2~3회 이상 들어가면 총 단백질 섭취가 부족하지 않은지 먼저 확인해야 합니다. 운동일뿐 아니라 휴식일도 중요합니다.",
  },
  {
    title: "러닝과 병행할 때 우선순위",
    body: "러닝 볼륨과 근력운동을 동시에 하는 주간에는 회복 부담이 커집니다. 주간 전체 식사 흐름 안에서 단백질과 탄수화물을 같이 설계하는 편이 안정적입니다.",
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <h1 className="mt-3 text-2xl font-bold leading-tight text-[var(--foreground)] md:text-3xl">근력운동을 병행하면 단백질 전략이 달라집니다</h1>
      ...
      <main className="mx-auto max-w-[1200px] px-4 py-8 md:px-6">
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            <h2 className="text-xl font-bold text-[var(--foreground)]">러닝과 병행할 때 왜 중요한가?</h2>
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--foreground-muted)]">근력운동을 병행한다면 운동 직후만 챙기기보다 아침부터 저녁까지 포함한 총량 흐름을 만드는 편이 좋습니다.</p>
            <div className="mt-5 overflow-x-auto rounded-2xl border border-[#ece9e2] bg-white">
              <table className="min-w-full border-collapse text-left text-sm">
                <thead>
                  <tr className="border-b border-[#e8e6e3] text-[var(--foreground)]">
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--foreground-muted)]">러닝과 근력운동을 같이 하는 사람에게는 운동 종류보다 주간 훈련 전체를 기준으로 총 섭취 전략을 보는 편이 더 실전적입니다.</p>
            <div className="mt-5 overflow-x-auto rounded-2xl border border-[#ece9e2] bg-white">
              <table className="min-w-full border-collapse text-left text-sm">
                <thead>
                  <tr className="border-b border-[#e8e6e3] text-[var(--foreground)]">
