...
export const metadata = {
  ...
  description:
    "러닝과 근력운동을 함께 하는 사용자에게 필요한 단백질 섭취 타이밍, 회복 포인트, 주간 총량 기준을 정리했습니다.",
};

const focusRows = [
  ["근력운동 직후", "20~40g", "근육 회복과 다음 세션 준비를 위한 기본 범위"],
  ["러닝 병행 주간", "1.6~2.0 g/kg/day", "지구력과 근력 훈련을 동시에 고려한 총량 기준"],
  ["감량기 근손실 방어", "2.0 g/kg/day 안팎", "총열량이 낮을수록 단백질 비중이 더 중요해집니다."],
];

const liftCards = [
  {
    title: "근력운동 후 1시간",
    body: "러닝과 함께 근력운동을 하는 주간에는 운동 후 회복 창을 놓치지 않는 편이 좋습니다. 탄수화물과 단백질을 함께 먹으면 체감 회복이 안정적입니다.",
  },
  {
    title: "주간 총량 유지",
    body: "근력운동을 2~3회 이상 한다면 총 단백질 섭취량이 부족하지 않은지 먼저 확인해야 합니다. 운동일만이 아니라 휴식일도 중요합니다.",
  },
  {
    title: "러닝과 병행할 때 우선순위",
    body: "러닝 볼륨과 근력운동이 동시에 늘면 회복 부담이 커집니다. 주간 전체 식사 흐름 안에서 단백질과 탄수화물을 같이 설계하는 편이 안정적입니다.",
  },
];

const sampleRows = [
  ["아침", "계란, 그릭요거트, 토스트", "단백질과 탄수화물로 하루를 시작"],
  ["운동 후", "웨이 또는 RTD 단백질 음료", "빠른 회복 루틴 연결"],
...
const scheduleRows = [
  ...
  ["러닝+근력 병행일", "운동 후 30g 안팎 + 전체 식사 보강", "세션 부담을 함께 고려"],
...
const checklist = [
  ...
  "고강도 하체 운동 다음 날 러닝이 있다면 회복 간격까지 함께 설계하기",
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            ...
            <br />
            근력운동이 들어가는 주간에는 총량과 운동 직후 회복식을 더 신경 써야 합니다.
          </p>
        </div>
      </section>
      <main className="mx-auto max-w-[1200px] px-4 py-8 md:px-6">
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            <h2 className="text-xl font-bold text-[var(--foreground)]">러닝과 함께할 때 왜 중요할까?</h2>
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--foreground-muted)]">
              근력운동을 병행한다면 운동 직후만 챙기기보다 아침부터 저녁까지 포함한 총량을 안정적으로 채우는 흐름이 더 좋습니다.
            </p>
            <div className="mt-5 overflow-x-auto rounded-2xl border border-[#ece9e2] bg-white">
              <table className="min-w-full border-collapse text-left text-sm">
                <thead>
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--foreground-muted)]">
              러닝과 근력운동을 같이 하는 사용자는 운동 종류보다 주간 훈련 전체를 기준으로 총 섭취 전략을 보는 편이 더 실전적입니다.
            </p>
            <div className="mt-5 overflow-x-auto rounded-2xl border border-[#ece9e2] bg-white">
              <table className="min-w-full border-collapse text-left text-sm">
                <thead>
