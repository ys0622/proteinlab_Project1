...
const starterCards = [
  {
    title: "총량부터 맞추기",
    body: "운동 직후만 챙기기 전에, 하루 총 단백질 섭취량이 부족하지 않은지 먼저 확인하는 것이 우선입니다.",
  },
  {
    title: "익숙한 음식부터",
...
const beginnerFaq = [
  ...
  },
  {
    ...
    body: "그렇습니다. 근육 회복은 휴식일에도 계속되기 때문에 운동일에만 몰아 먹기보다 매일 일정하게 챙기는 편이 좋습니다.",
  },
];
      ...
      <main className="mx-auto max-w-[1200px] px-4 py-8 md:px-6">
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e8e6e3] bg-[#fffdf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--foreground-muted)]">
              처음부터 완벽한 계획을 세우기보다 가장 쉬운 루틴을 고정하는 것이 더 오래 갑니다.
            </p>
            <div className="mt-5 overflow-x-auto rounded-2xl border border-[#ece9e2] bg-white">
              <table className="min-w-full border-collapse text-left text-sm">
                <thead>
