...
export const metadata = {
  ...
  description:
    "운동을 막 시작한 사용자를 위한 단백질 전략 가이드입니다. 식사, 간식, 제품 선택을 쉽게 연결할 수 있게 정리했습니다.",
};

const starterCards = [
  {
    title: "총량부터 맞추기",
    body: "운동 직후를 챙기기 전에, 하루 총 단백질 섭취량이 부족하지 않은지 먼저 보는 것이 우선입니다.",
  },
  {
    title: "익숙한 음식부터",
    body: "달걀, 우유, 그릭요거트, 두부처럼 일상 식품으로 시작하면 부담 없이 루틴을 만들기 쉽습니다.",
  },
  {
    title: "제품은 보충용",
    body: "단백질 음료나 바는 식사를 완전히 대체하기보다, 부족한 구간을 채우는 보조 도구로 보는 편이 좋습니다.",
  },
];

const sampleRows = [
  ["아침", "달걀 + 토스트 + 우유", "가장 간단한 단백질 시작점"],
  ["점심", "일반 식사 + 고기·두부", "식사에서 단백질 식품 우선"],
  ["운동 후 간식", "RTD 음료 또는 요거트", "편하게 회복식 연결"],
  ["저녁", "생선·닭고기 + 밥", "하루 총량 마무리"],
];

const checklist = [
  "운동 주 2~3회라도 식사마다 단백질 식품을 넣기",
  "제품 선택 시 단백질 g, 당류, 칼로리를 같이 보기",
  "처음부터 고단백 제품만 찾기보다 지속 가능한 루틴 만들기",
  "배가 불편하면 락토프리나 식물성 제품도 고려하기",
];

const beginnerFaq = [
  {
    title: "운동을 시작하면 단백질 음료가 꼭 필요할까?",
    body: "필수는 아닙니다. 식사만으로 충분히 채울 수 있다면 제품은 보조 수단입니다. 다만 운동 후 식사를 놓치기 쉬운 사람에게는 RTD 음료가 편리한 선택지가 될 수 있습니다.",
  },
  {
    title: "처음부터 고단백 제품을 골라야 할까?",
    body: "무조건 높은 수치보다 부담 없이 꾸준히 먹을 수 있는 제품이 먼저입니다. 초보자는 단백질 함량, 당류, 칼로리의 균형을 같이 보는 편이 좋습니다.",
  },
  {
    title: "운동을 안 하는 날에도 단백질을 챙겨야 할까?",
    body: "네. 근육 회복은 휴식일에도 계속되기 때문에, 훈련일만 챙기고 쉬는 날에 비워 두면 총량이 부족해질 수 있습니다.",
  },
];

const starterFlow = [
  ["1단계", "하루 식사 3끼부터 점검", "매 끼니에 단백질 식품 1개 넣기"],
  ["2단계", "간식 한 번 보완", "요거트, 우유, RTD 중 가장 쉬운 것부터"],
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            운동을 막 시작한 사용자는 복잡한 보충제 루틴보다,
            <br />
            식사와 간식에 단백질을 자연스럽게 넣는 습관부터 만드는 편이 훨씬 현실적입니다.
          </p>
        </div>
      </section>
        ...
        <div className="space-y-6">
          <section className="rounded-[28px] border border-[#e8e6e3] bg-[#fffdf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <h2 className="mt-2 text-xl font-bold text-[var(--foreground)]">운동 초보가 먼저 잡아야 하는 기준</h2>
              </div>
          ...
          <section className="rounded-[28px] border border-[#e8e6e3] bg-[#fffdf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--foreground-muted)]">
              제품을 억지로 넣기보다 일상 식사에 단백질 식품을 먼저 배치하고, 부족한 구간만 간편 제품으로 채우는 흐름이 좋습니다.
            </p>
          ...
          <section className="rounded-[28px] border border-[#e8e6e3] bg-[#fffdf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-3 text-sm leading-6 text-[var(--foreground-muted)]">
              처음부터 완벽한 계획을 세우기보다, 가장 쉬운 루틴을 고정하는 편이 더 오래 갑니다.
            </p>
