...
export const metadata = {
  ...
  description:
    "러닝, 마라톤, 운동 영양, 근력운동, 운동 초보, 봄 시즌 야외활동 가이드를 Track D에서 정리합니다.",
};
...
const topics = [
  {
    ...
    description: "러너에게 필요한 하루 단백질 기준, 운동 후 회복 타이밍, 제품 비교 포인트를 먼저 정리합니다.",
  ...
  },
  {
    ...
    description: "훈련기와 레이스 주간을 나눠 보고, 카보로딩과 회복 식단까지 연결해서 설명합니다.",
  ...
  },
  {
    ...
    description: "5km, 10km, 하프, 풀 마라톤을 거리별로 나눠 훈련 포인트와 영양 전략을 비교합니다.",
  ...
  },
  {
    ...
    description: "운동 목적에 따라 어떤 제품이 맞는지, 단백질 종류와 당류·칼로리 기준을 함께 정리합니다.",
  ...
  },
  {
    ...
    description: "러닝과 병행하는 근력운동에서 총량, 회복 타이밍, 감량기 전략을 함께 정리합니다.",
  ...
  },
  {
    ...
    description: "운동을 막 시작한 사람에게 필요한 식사 구조, 제품 사용법, 체크리스트를 가볍게 정리합니다.",
  ...
  },
  {
    ...
    description: "봄철 체중 관리 시즌에 음료, 바, 요거트를 어떤 기준으로 가볍게 골라야 하는지 정리합니다.",
    question: "봄 다이어트에는 어떤 단백질 기준이 더 중요할까?",
  ...
  },
  {
    ...
    description: "봄에 러닝을 다시 시작할 때 회복 루틴과 가벼운 제품 선택 기준을 먼저 정리합니다.",
  ...
  },
  {
    ...
    description: "피크닉, 가벼운 등산, 야외활동에서 챙기기 좋은 단백질 간식 기준을 정리합니다.",
