...
export const metadata = {
  ...
  description:
    "벌크업, 체중 관리, 회복 중점 운동까지 목적에 맞는 단백질 음료를 고르는 기준을 정리합니다. 단백질 함량, 당류, 칼로리를 함께 비교하세요.",
};

const productRows = [
  ["게이너·매스형", "복합형(단백질+탄수화물)", "30~45g", "중간", "높음", "200~350kcal", "벌크업, 체중 증가"],
  ["고단백 RTD", "순수 단백질 중점", "20~30g", "낮음", "중간", "100~180kcal", "운동 후 회복"],
  ["저당 RTD", "저당 또는 분리유청", "20~25g", "낮음", "낮음", "90~140kcal", "다이어트, 체중 관리"],
  ["식물성 RTD", "저당·식물성 단백질", "15~25g", "중간", "낮음", "100~170kcal", "식물성 선호, 유당 부담"],
  ["드링킹·요거트형", "발효유형 단백질 강화", "10~20g", "중간", "중간", "90~160kcal", "간편 간식, 아침 보완"],
];

const flowCards = [
  {
    title: "회복이 우선일 때",
    body: "운동 직후 빠르게 마실 수 있는 제품이 필요하다면 단백질 함량 20g 이상, 당류는 낮고 소화 부담이 적은 RTD부터 고르는 편이 안정적입니다.",
    product: "예시: 고단백 RTD",
  },
  {
    title: "체중 관리가 우선일 때",
    body: "칼로리와 당류를 먼저 보고 단백질 밀도까지 확인해야 합니다. 같은 20g 단백질이라도 총열량과 당류가 다르면 쓰임새가 달라집니다.",
    product: "예시: 저당 RTD",
  },
  {
    title: "벌크업이 우선일 때",
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            단백질 음료 선택은 단순히 단백질 g만 보면 끝나지 않습니다.
            <br />
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <p className="mt-4 text-xs text-[var(--foreground-muted)]">
              비교 기준: ProteinLab 제품 데이터, 운동 후 단백질 전략 가이드, 일반적인 RTD 제품군 특성
            </p>
          </section>
            ...
            <div className="mt-5 grid gap-3 md:grid-cols-2">
              <article className="rounded-2xl border border-[#dce8df] bg-[#f6fbf7] p-4 shadow-[0_12px_30px_rgba(45,106,79,0.06)]">
                ...
                <p className="mt-2 text-sm leading-6 text-[var(--foreground-muted)]">
                  20g 이상 단백질을 빠르게 보충할 수 있는 RTD가 가장 무난합니다. 당류가 과하지 않고 마시기 쉬운 구성을 먼저 보세요.
                </p>
              </article>
              <article className="rounded-2xl border border-[#dce8df] bg-[#f6fbf7] p-4 shadow-[0_12px_30px_rgba(45,106,79,0.06)]">
                <p className="text-sm font-semibold text-[#24543d]">체중 관리가 우선이라면</p>
                <p className="mt-2 text-sm leading-6 text-[var(--foreground-muted)]">
                  저당, 저칼로리, 단백질 밀도 순으로 좁혀 보세요. 같은 20g 단백질이어도 총열량과 당류가 다르면 다이어트 효율이 달라집니다.
                </p>
              </article>
            </div>
          </section>
