...
export const metadata = {
  title: "운동 목적별 단백질 제품 선택 기준 | ProteinLab",
  description:
    "벌크업, 체중 관리, 회복 중심 운동까지 목적에 맞는 단백질 제품을 고르는 기준을 정리합니다. 단백질 함량, 당류, 칼로리를 함께 비교하세요.",
};

const productRows = [
  ["게이너·밀크쉐이크형", "복합형(단백질+탄수화물)", "30~45g", "중간", "높음", "200~350kcal", "벌크업, 체중 증가"],
...
const flowCards = [
  {
    title: "회복이 우선일 때",
    body: "운동 직후 빠르게 마실 수 있는 제품이 필요하다면 단백질 함량 20g 이상, 당류는 낮고 소화 부담이 적은 RTD부터 보는 편이 안정적입니다.",
    product: "예시: 고단백 RTD",
  },
  {
    title: "체중 관리가 우선일 때",
    body: "칼로리와 당류를 먼저 보고 단백질 밀도까지 확인해야 합니다. 같은 20g 단백질이어도 총열량과 당류가 다르면 의미가 달라집니다.",
    product: "예시: 저당 RTD",
  },
  {
    title: "벌크업이 우선일 때",
    body: "단백질 g만 보는 것이 아니라 탄수화물 보강, 총칼로리, 운동 직후 섭취 편의성까지 같이 봐야 실제 체중 증가 루틴과 맞습니다.",
    product: "예시: 게이너·밀크쉐이크형",
  },
];
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <h1 className="mt-3 text-2xl font-bold leading-tight text-[var(--foreground)] md:text-3xl">
            운동 목적에 따라 단백질 제품을 고르는 기준
          </h1>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            단백질 제품 선택은 단순히 단백질 g만 보면 끝나지 않습니다.
            <br />
        ...
        <div className="space-y-6">
          <section className="rounded-[28px] border border-[#e2ebe4] bg-white px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <span className="rounded-full bg-[#eff7f1] px-3 py-1 text-xs font-semibold text-[#2d6a4f]">제품 선택 플로우</span>
            </div>
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <div className="mt-5 grid gap-3 md:grid-cols-2">
              ...
              <article className="rounded-2xl border border-[#dce8df] bg-[#f6fbf7] p-4 shadow-[0_12px_30px_rgba(45,106,79,0.06)]">
                ...
                <p className="mt-2 text-sm leading-6 text-[var(--foreground-muted)]">
                  저당·저칼로리·단백질 밀도를 같이 보세요. 같은 20g 단백질이어도 총열량과 당류가 다르면 다이어트 효율이 달라집니다.
                </p>
              </article>
            </div>
          </section>
