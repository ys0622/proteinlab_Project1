...
export const metadata = {
  ...
  description:
    "봄철 체중 관리 시즌에는 단백질 음료, 단백질 바, 단백질 요거트를 어떤 기준으로 고르면 좋은지 칼로리와 당류, 포만감 중심으로 정리했습니다.",
};

const springSignals = [
  {
    title: "가벼운 감량 수요 증가",
    body: "봄에는 무리한 벌크업보다 가벼운 체중 관리와 식단 정리에 대한 관심이 높아집니다. 그래서 단순 고단백보다 칼로리와 당류 균형이 중요해집니다.",
  },
  {
    title: "야외활동 전환",
    body: "겨울보다 활동량이 늘어나면서 식사 사이를 가볍게 보완하는 제품 수요가 함께 커집니다.",
  },
  {
    title: "아침·간식 수요 증가",
...
const categoryRows = [
  ["단백질 음료", "단백질 함량, 칼로리, 당류", "가벼운 보완형과 식사보완형을 먼저 구분하는 편이 좋습니다."],
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            ...
            <br />
            그래서 단백질 함량뿐 아니라 칼로리, 당류, 포만감을 함께 보는 흐름이 더 중요해집니다.
          </p>
        </div>
      </section>
