...
export const metadata = {
  ...
  description:
    "단백질 보충 제품이 언제 식사대용에 가까워지는지, 보충형과 어떤 기준으로 구분해야 하는지 정리합니다.",
};

const replacementRows = [
  ["가벼운 RTD", "보충형에 가깝다", "단백질이 충분해도 칼로리와 포만감이 식사를 대체하기엔 부족한 경우가 많습니다."],
  ["바 형태 고단백", "상황별 식사 보완", "칼로리와 포만감이 어느 정도 있어 바쁜 일정에서 보완용으로 쓰기 좋습니다."],
...
const keyPoints = [
  ...
  {
    title: "지속 가능성",
    body: "매일 반복해야 하는 루틴이라면 맛, 질감, 위장 부담까지 함께 봐야 실제로 오래 갑니다.",
  },
];
...
const useCases = [
  ...
  "운동 후 바로 식사하기 어렵지만 공복이 길어지면 안 되는 날",
];
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            모든 단백질 음료가 식사대용은 아닙니다. 포만감과 칼로리, 다음 끼니까지의 거리까지 같이 봐야 기준이 분명해집니다.
          </p>
        </div>
      </section>
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-[#f7fbf8] px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <div className="mt-4 rounded-2xl border border-[#dce8df] bg-white px-4 py-4">
              ...
              <p className="mt-2 text-sm leading-6 text-[var(--foreground-muted)]">
                단백질 함량이 많다고 식사대용이 되지는 않습니다. 포만감, 칼로리, 다음 끼니까지의 거리까지 같이 봐야 합니다.
              </p>
            </div>
