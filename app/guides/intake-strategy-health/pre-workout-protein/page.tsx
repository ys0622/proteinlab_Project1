...
const beforeWorkoutRows = [
  ["직전 식사를 한 경우", "추가 보충보다 식사 상태 확인", "소화 부담을 줄이고 운동 집중력을 유지하려면 마지막 식사와의 간격을 먼저 봐야 합니다."],
...
const quickRules = [
  {
    ...
    body: "마지막 식사가 2~3시간 이내라면 운동 전 단백질을 추가로 챙기지 않아도 되는 경우가 많습니다.",
  },
  {
    title: "소화 부담이 적은 형태 고르기",
    body: "운동 직전에는 꾸덕한 바보다 가벼운 RTD나 소량 제품이 맞는 경우가 많습니다.",
  },
  {
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            운동 전에 단백질을 챙길지보다 소화 부담과 직전 식사 유무를 먼저 생각하는 편이 더 실전적입니다.
          </p>
        </div>
      </section>
