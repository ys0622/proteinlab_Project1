...
const timingRows = [
  ["아침", "20~30g", "공복 시간이 길었다면 첫 식사에서 단백질을 채워 하루 시작 리듬을 안정적으로 만드는 데 도움 됩니다."],
  ["운동 전", "상황별 판단", "직전 식사 유무와 소화 부담을 먼저 보고 결정합니다. 무조건 추가 보충이 필요한 구간은 아닙니다."],
  ["운동 후", "20~30g", "운동 후 1시간 전후에서 회복 시작 신호를 만들고 다음 식사까지 루틴을 연결하는 데 초점을 둡니다."],
  ["간식·저녁", "20~30g", "하루 총량이 부족할 때 간식이나 저녁 식사에서 보완하면 전체 단백질 분산 섭취가 쉬워집니다."],
];
...
const principles = [
  ...
  {
    title: "한 번에 몰아먹지 않기",
    body: "여러 끼에 나눠 먹는 쪽이 지속하기도 쉽고, 아침·간식·운동 후처럼 생활 패턴 안에 자연스럽게 넣기 좋습니다.",
  },
  {
    title: "생활 루틴에 맞추기",
...
const routineRows = [
  ...
  ["저녁 운동형", "점심~간식에서 미리 총량 확보, 운동 후 RTD 또는 식사", "운동 후 과식과 결식으로 흐르지 않게 루틴을 잇기 좋습니다."],
