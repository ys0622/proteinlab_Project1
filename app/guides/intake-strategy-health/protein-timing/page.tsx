...
export const metadata = {
  ...
  description:
    "아침, 운동 전후, 간식, 저녁까지 하루 전체 루틴 안에서 단백질을 언제 배치하면 좋은지 실전 기준으로 정리했습니다.",
};

const timingRows = [
  ["아침", "20~30g", "공복 시간이 길었다면 첫 식사에서 단백질을 채워 하루 시작 리듬을 안정적으로 만드는 데 도움이 됩니다."],
  ["운동 전", "상황별 판단", "직전 식사 유무와 소화 부담을 먼저 보고 결정합니다. 무조건 추가 보충이 필요한 구간은 아닙니다."],
  ["운동 후", "20~30g", "운동 후 1시간 안팎에서 회복 시작 신호를 만들고, 다음 식사까지 루틴을 연결하는 데 초점을 둡니다."],
  ["간식·저녁", "20~30g", "하루 총량이 부족할 때 간식이나 저녁 식사에서 보완하면 전체 단백질 분산이 훨씬 쉬워집니다."],
];

const principles = [
  {
    title: "운동 직후만 보지 않기",
    body: "운동 후 보충도 중요하지만 실제 결과는 하루 총량과 분산 섭취가 더 크게 좌우합니다. 타이밍은 총량을 잘 채우기 위한 도구로 보는 편이 실전적입니다.",
  },
  {
    title: "한 번에 몰아먹지 않기",
    body: "여러 끼에 나눠 먹는 쪽이 지속하기 쉽고, 아침·간식·운동 후처럼 생활 패턴 안에 자연스럽게 넣기도 좋습니다.",
  },
  {
    title: "생활 루틴에 맞추기",
    body: "출근 전 운동, 저녁 운동, 야외 활동처럼 일정이 다르면 좋은 타이밍도 달라집니다. 반복 가능한 루틴이 우선입니다.",
  },
];

const routineRows = [
  ["아침 운동형", "기상 후 가벼운 보완, 운동 후 단백질 보충", "공복감을 줄이고 회복 루틴을 빠르게 만드는 데 유리합니다."],
  ["저녁 운동형", "점심~간식에서 미리 총량 확보, 운동 후 RTD 또는 식사", "운동 후 과식과 야식으로 흐르지 않게 루틴을 잡기 좋습니다."],
  ["운동 없는 날", "아침과 간식에서 균등 분산", "운동일과 휴식일의 섭취 격차를 너무 크게 만들지 않는 데 도움이 됩니다."],
];
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            운동 후 한 번만 따로 떼어 보기보다, 하루 전체 식사 안에서 단백질이 어떻게 분산되는지 보는 편이 더 실전적입니다.
          </p>
        </div>
      </section>
        ...
        <div className="space-y-6">
          ...
          <section className="rounded-[28px] border border-[#e2ebe4] bg-white px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
            ...
            <blockquote className="mt-5 rounded-xl border border-[#dce8df] bg-[#f7fbf8] px-4 py-4 text-sm leading-6 text-[var(--foreground-muted)]">
              좋은 타이밍은 정답이 하나인 것이 아니라, 일정 안에서 무너지지 않고 반복할 수 있는 배치입니다.
            </blockquote>
          </section>
          <section className="rounded-[28px] border border-[#e2ebe4] bg-white px-5 py-5 shadow-[0_18px_50px_rgba(20,32,24,0.04)]">
