...
export const metadata = {
  ...
  description:
    "아침, 운동 전후, 간식, 저녁까지 하루 전체 루틴 안에서 단백질을 언제 배치하면 좋은지 실전 기준으로 정리합니다.",
};

const timingRows = [
  ["아침", "20~30g", "공복 시간이 길었다면 첫 식사에서 단백질을 채워 하루 시작 리듬을 안정적으로 만드는 데 좋습니다."],
  ...
  ["간식·저녁", "20~30g", "하루 총량이 부족할 때 간식이나 저녁 식사에서 보완하면 전체 단백질 분산이 쉬워집니다."],
];

const principles = [
  {
    title: "운동 직후만 보지 않기",
    body: "운동 후 보충은 중요하지만 실제 결과는 하루 총량과 분산 섭취가 더 크게 좌우합니다. 타이밍은 총량을 채우기 위한 도구로 보는 편이 실전적입니다.",
  },
  {
    title: "한 번에 몰아먹지 않기",
    body: "여러 끼에 나눠 먹는 쪽이 지속하기도 쉽고, 아침·간식·운동 전후처럼 생활 패턴 안에 자연스럽게 넣기 좋습니다.",
  },
  {
    title: "생활 루틴에 맞추기",
    body: "출근 전 운동, 저녁 운동, 재택 일정처럼 하루 패턴이 다르면 좋은 타이밍도 달라집니다. 반복 가능한 루틴이 우선입니다.",
  },
];

const routineRows = [
  ["아침 운동형", "기상 후 가벼운 보충, 운동 후 단백질 보충", "공복감을 줄이고 회복 루틴을 빠르게 만드는 데 유리합니다."],
  ["저녁 운동형", "점심~간식에서 미리 총량 확보, 운동 후 RTD 또는 식사", "운동 후 과식과 결식으로 나뉘지 않게 루틴을 잇기 좋습니다."],
  ["운동 없는 날", "아침과 간식에서 고르게 분산", "운동일과 휴식일의 섭취 격차를 너무 크게 만들지 않는 데 유용합니다."],
];
