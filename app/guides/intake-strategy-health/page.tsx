      ...
      <main className="mx-auto max-w-[1200px] px-4 pb-12 md:px-6">
        <section className="mt-5">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[...featuredTopics, ...supportingTopics].map((topic: IntakeTopicCard, index) => (
              <Link
                key={topic.href}
                href={topic.href}
              ...
              >
                ...
                <div className="flex flex-1 flex-col justify-between px-4 py-4 sm:px-5">
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-6 text-[var(--foreground-muted)]" style={clampThreeLines}>{topic.description}</p>
