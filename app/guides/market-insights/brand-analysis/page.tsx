...
const brandRows = [
  ...
  ["오늘단백", "하림", "식품기업 신규 진입", "축산·식품 기업이 단백질 카테고리에 새로 진입한 사례입니다."],
  ["오뚜기 데이프로틴", "오뚜기", "종합식품 신규 진입", "대형 종합식품기업까지 RTD 단백질 시장에 뛰어든 흐름을 보여줍니다."],
];
...
const positionCards = [
  ...
  {
    title: "식품기업 신규 진입 브랜드",
    brands: "오늘단백(하림), 오뚜기 데이프로틴",
    body: "기존 유제품·건강기능식품 회사 중심이던 시장에 축산·종합식품 기업이 새로 뛰어들면서 카테고리 자체가 커지고 있습니다.",
  },
];
...
const readingPoints = [
  ...
  "최근에는 하림, 오뚜기처럼 기존에 단백질 전문이 아니었던 식품기업까지 RTD 단백질 시장에 진입하고 있어 브랜드 수 자체가 빠르게 늘고 있습니다.",
];
