...
export const metadata = {
  ...
  alternates: { canonical: "https://proteinlab.kr/guides/market-insights/ingredient-trends" },
  openGraph: {
    title: _pageTitle,
    description: _pageDesc,
...
const trendCards = [
  {
    title: "저당",
    tag: "체중 관리",
    body: "체중 관리와 일상 간식 수요가 커지면서 단순 고단백보다 저당 조건이 더 중요해지고 있습니다.",
  },
  {
    title: "워터형",
    tag: "가벼운 보충",
  ...
  },
  {
    title: "식사대용형",
    tag: "간편 식사",
    body: "단백질만이 아니라 포만감과 식사 대체 맥락까지 함께 보는 제품이 늘고 있습니다.",
  },
];
      ...
      <section className="w-full border-t border-b bg-[var(--hero-bg)]" style={{ borderColor: "var(--hero-border)" }}>
        <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-6 md:py-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--foreground-muted)]">
            ...
            <br />
            저당, 워터형, 식물성, 락토프리 같은 키워드가 실제 선택 기준을 바꾸고 있습니다.
          </p>
        </div>
      </section>
