    ...
    <div className="mt-6 space-y-6">
      <section className="grid gap-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
        <form
          ...
          className="rounded-[28px] border border-[#c5dcc9] bg-[linear-gradient(135deg,#f4faf5_0%,#eaf4ed_100%)] px-5 py-5 shadow-[0_18px_50px_rgba(45,106,79,0.08)]"
        >
          ...
          <div className="mt-5 space-y-4">
            <label className="block">
              ...
              <div className="mt-2 flex items-center rounded-xl border border-[#c5dcc9] bg-white px-4 py-3 transition-all focus-within:border-[#2d6a4f] focus-within:ring-2 focus-within:ring-[#2d6a4f]/10">
                <input
                  type="number"
                  min="1"
                  step="0.1"
            ...
            <label className="block">
              <span className="text-sm font-semibold text-[var(--foreground)]">활동량</span>
              <select
                value={activity}
                onChange={(event) => setActivity(event.target.value as ActivityLevel)}
                className="mt-2 w-full rounded-xl border border-[#c5dcc9] bg-white px-4 py-3 text-sm text-[var(--foreground)] outline-none transition-all focus:border-[#2d6a4f] focus:ring-2 focus:ring-[#2d6a4f]/10"
              >
          ...
          <button
            type="submit"
            className="mt-5 flex w-full items-center justify-center rounded-xl bg-[#2d6a4f] py-3 text-sm font-semibold text-white transition-colors hover:bg-[#24543d]"
          >
            계산하기
          </button>
        </form>
