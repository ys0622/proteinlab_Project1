...
const drinkPicks: PickConfig[] = [
  {
    slug: "zero-sugar",
    title: "당류 0g 단백질 음료",
    description: "당류 0g인 단백질 음료만 모았습니다. 다이어트·혈당 관리에 적합한 제품을 비교해 보세요. proteinlab.kr 기준 큐레이션.",
    productType: "drink",
  ...
  },
  {
    ...
    title: "라이트 단백질 20g 미만 음료",
    description: "1병당 단백질 20g 미만의 가벼운 단백질 음료 목록. 부담 없이 마시는 라이트 보충용 제품 비교.",
    productType: "drink",
  ...
  },
  {
    ...
    description: "1병당 단백질 20g 이상 고단백 음료 비교. 운동 후·근력 보충에 추천하는 제품 목록.",
    productType: "drink",
  ...
  {
    slug: "high-protein",
    title: "초고단백 30g 이상 단백질 음료",
    description: "1병당 단백질 30g 이상 초고단백 음료. 강도 높은 운동·고단백 요구 시 추천 제품.",
    productType: "drink",
  ...
  },
  {
    slug: "lactose-free",
    title: "락토프리 단백질 음료",
    description: "락토프리(유당 제거) 단백질 음료 목록. 유당 불내증·소화 부담이 있는 분들을 위한 제품.",
    productType: "drink",
  ...
  {
    slug: "value-a",
    title: "단백질 밀도 A 등급 음료",
    description: "단백질 밀도 A 등급 단백질 음료. 용량 대비 단백질 함량이 높은 제품 비교.",
    productType: "drink",
  ...
  {
    slug: "diet-a",
    title: "다이어트 A 등급 단백질 음료",
    description: "다이어트 A 등급 단백질 음료. 칼로리·당 효율이 좋은 제품 추천.",
    productType: "drink",
  ...
  {
    slug: "fitness-a",
    title: "퍼포먼스 A 등급 단백질 음료",
    description: "퍼포먼스 A 등급 단백질 음료. 운동·퍼포먼스 보충에 적합한 제품 비교.",
    productType: "drink",
  ...
  },
  {
    slug: "vegan",
    title: "식물성 단백질 음료",
    description: "식물성(비건) 단백질 음료 비교. 우유 없이 식물 단백질로 만든 제품 목록.",
    productType: "drink",
...
const barPicks: PickConfig[] = [
  {
    ...
    description: "1개당 단백질 20g 이상 단백질 바 비교. 운동 후·고단백 보충에 적합한 제품.",
    productType: "bar",
  ...
  },
  {
    ...
    title: "고단백 15g 이상 단백질 바",
    description: "1개당 단백질 15g 이상 단백질 바. 적당한 단백질 보충이 필요한 경우 추천.",
    productType: "bar",
  ...
  },
  {
    slug: "bar-low-sugar",
    title: "저당 단백질 바",
    description: "저당 단백질 바 비교. 당류 5g 미만·당류 0g 제품으로 다이어트·당 관리에 도움.",
    productType: "bar",
  ...
  },
  {
    ...
    title: "저칼로리 단백질 바",
    description: "저칼로리 단백질 바 목록. 200kcal 미만 등 칼로리 부담을 줄인 제품 비교.",
    productType: "bar",
  ...
  },
  {
    slug: "bar-choco",
    title: "초코 맛 단백질 바",
    description: "초콜릿·다크초코 맛 단백질 바 비교. 맛있게 먹는 단백질 보충.",
    productType: "bar",
  ...
  },
  {
    slug: "bar-nut",
    title: "견과류 단백질 바",
    description: "견과·땅콩·아몬드 함유 단백질 바. 고소한 맛과 포만감.",
    productType: "bar",
  ...
  },
  {
    slug: "bar-no-nut",
    title: "무견과 단백질 바",
    description: "견과류 알레르기·무견과 단백질 바. 견과 없이 만든 제품 비교.",
    productType: "bar",
  ...
  },
  {
    slug: "bar-large",
    title: "대용량 단백질 바",
    description: "60g 이상 대용량 단백질 바. 한 개로 든든한 보충.",
    productType: "bar",
  ...
  },
  {
    slug: "bar-small",
    title: "소용량 단백질 바",
    description: "50g 이하 소용량 단백질 바. 가벼운 간식·소포장 보충.",
    productType: "bar",
  ...
  },
  {
    ...
    title: "고밀도 단백질 바",
    description: "단백질 밀도가 높은 단백질 바. 100kcal당 8g 이상 단백질 제품 (proteinlab.kr 기준).",
    productType: "bar",
