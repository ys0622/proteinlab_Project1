  ...
  },
  {
    ...
    slots: [
      ...
      },
      {
        ...
        searchIntent: "단백질 50g 한번에 먹어도 될까",
        futureFocus: ["체중별 기준", "타이밍별 판단", "제품 연결"],
        internalLinkTargets: [
          { label: "고단백 음료 부담·부작용", href: "/guides/intake-strategy-health/high-protein-side-effects" },
          { label: "50g 이상 음료 비교", href: "/guides/product-selection-comparison/high-protein-50g-comparison" },
        ],
      },
      {
        slug: "high-protein-side-effects",
        title: "고단백 음료 부담·부작용",
        description: "60g대 초고단백 제품까지 나온 지금, 소화 부담·과다 섭취 우려를 정면으로 다루는 가이드입니다.",
        searchIntent: "프로틴 많이 먹으면 부작용",
        futureFocus: ["부작용 정리", "적정 대상 구분", "중단백 대안 연결"],
        internalLinkTargets: [
          { label: "단백질 50g 한 번에", href: "/guides/intake-strategy-health/protein-50g-at-once" },
          { label: "중단백 대안 추천", href: "/topics/mid-protein-alternatives" },
        ],
      },
      {
      ...
      },
      {
        ...
        searchIntent: "다이어트 단백질 음료 어떻게",
        futureFocus: ["저당 기준", "저칼로리 판단", "체중 관리 연결"],
        internalLinkTargets: [
      ...
      {
        slug: "protein-drink-meal-replacement",
        title: "단백질 음료 식사대용 가능할까",
        description: "단백질 음료를 식사 대용으로 써도 되는지 영양 구성 기준으로 판단하는 방법을 정리합니다.",
        searchIntent: "단백질 음료 식사대용 가능할까",
        futureFocus: ["영양 구성 판단", "식사대용 기준", "제품 연결"],
        internalLinkTargets: [
          { label: "식사대용 전략", href: "/guides/intake-strategy-health/meal-replacement-strategy" },
          { label: "아침 대용 단백질 음료", href: "/guides/intake-strategy-health/morning-protein-drink" },
        ],
      },
      {
        ...
        searchIntent: "운동 안 해도 단백질 음료",
        futureFocus: ["비운동자 기준", "영양 보충 목적", "과다 섭취 주의"],
        internalLinkTargets: [
          { label: "고단백 음료 부담·부작용", href: "/guides/intake-strategy-health/high-protein-side-effects" },
          { label: "단백질 음료 추천", href: "/topics/protein-drink-recommend" },
        ],
      },
      {
        slug: "night-protein-drink",
        title: "밤에 단백질 음료 마셔도 될까",
        description: "야식·저녁 시간대 단백질 음료 섭취가 괜찮은지 소화 부담과 수면 영향 기준으로 정리합니다.",
        searchIntent: "밤에 단백질 음료 마셔도 될까",
        futureFocus: ["야식 기준", "소화 부담", "수면 영향"],
        internalLinkTargets: [
          { label: "단백질 섭취 타이밍", href: "/guides/intake-strategy-health/protein-timing" },
          { label: "체중 관리와 단백질", href: "/guides/intake-strategy-health/weight-management-protein" },
        ],
      },
      {
        slug: "lean-massup-protein-intake",
        title: "린매스업 단백질 섭취량 계산",
        description: "체중별로 린매스업 목적일 때 하루 몇 g의 단백질이 필요한지 계산 기준을 정리합니다.",
        searchIntent: "린매스업 단백질 섭취량",
        futureFocus: ["체중별 계산", "벌크업 연결", "제품 추천"],
        internalLinkTargets: [
      ...
      {
        slug: "protein-drink-mainstream-shift",
        title: "단백질 음료, 이제 근육 늘리려고만 마시지 않습니다",
        description: "근비대 목적 중심이던 소비가 영양 보충·식사대용 목적으로 확대된 흐름과 그에 맞는 선택 기준을 정리합니다.",
        searchIntent: "단백질 음료 운동 안해도",
        futureFocus: ["소비 목적 다양화", "비운동자 기준", "식사대용 연결"],
        internalLinkTargets: [
          { label: "운동 안 해도 단백질 음료", href: "/guides/intake-strategy-health/protein-drink-without-exercise" },
          { label: "식사대용 가능할까", href: "/guides/intake-strategy-health/protein-drink-meal-replacement" },
        ],
      },
    ],
  },
