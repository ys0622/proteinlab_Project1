...
const exactNutritionBySlug: Record<string, NutritionPatch> = {
  ...
  "labnosh-cookiebar-blackcookie-35": {
    caloriesKcal: 145,
    proteinG: 4,
    carbsG: 24,
    sugarsG: 13,
  ...
  "labnosh-cookiebar-cookie-cream-35": {
    caloriesKcal: 137,
    proteinG: 7,
    carbsG: 20,
    sugarsG: 7,
  ...
  "labnosh-cookiebar-peanutbutter-35": {
    caloriesKcal: 155,
    proteinG: 7,
    carbsG: 18,
    sugarsG: 7,
  ...
  "oneuldanbaek-milkchoco-strawberry-bar-48": {
    caloriesKcal: 172,
    proteinG: 16,
    carbsG: 20,
    sugarsG: 4,
  ...
  "oneuldanbaek-milkchoco-cheesecake-bar-48": {
    caloriesKcal: 161,
    proteinG: 16,
    carbsG: 20,
    sugarsG: 4,
  ...
  "oneuldanbaek-milkchoco-caramel-bar-48": {
    caloriesKcal: 180,
    proteinG: 16,
    carbsG: 19,
    sugarsG: 3,
  ...
  "oneuldanbaek-milkchoco-pistachio-bar-48": {
    caloriesKcal: 175,
    proteinG: 16,
    carbsG: 18,
    sugarsG: 3,
