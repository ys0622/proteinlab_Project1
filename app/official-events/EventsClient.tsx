...
const rawDrinkBrands: BrandCard[] = [
  {
    ...
    productCount: 15,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "프로틴 밸런스 라인은 묶음 구성과 회원 등급 적립 반영 여부에 따라 체감가 차이가 납니다. 상품 페이지 표시가보다 장바구니 적용가와 배송비를 함께 확인하세요." },
  ...
  },
  {
    ...
    events: [
      ...
      { category: "쿠폰", periodLabel: "수시 진행", description: "스마트스토어 쿠폰이 붙는 경우가 많아 상품 페이지보다 장바구니 단계에서 최종 혜택을 다시 확인하는 편이 좋습니다." },
    ],
  },
  {
    brand: "셀렉스",
    ...
    productCount: 10,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "대용량 묶음 할인과 선물형 세트 구성이 함께 노출될 수 있습니다. 단품보다 세트 총액과 사은 구성을 함께 비교하는 편이 좋습니다." },
  ...
  },
  {
    ...
    events: [
      ...
      { category: "쿠폰", periodLabel: CHECKED_DATE_LABEL, description: "쿠폰존, 웰페이, 네이버페이 적립이 함께 붙는지 결제 직전에 확인하는 편이 좋습니다. 뉴케어는 쿠폰과 결제수단 혜택이 같이 보일 때 체감가 차이가 커집니다." },
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "올프로틴 고소한맛·초코맛·바나나맛은 행사 페이지와 묶음 구성을 먼저 확인할 가치가 높습니다. 체험팩, 액티브 라인, 24팩 구성을 나눠 보고 단품보다 기획전 진입가를 우선 확인하세요." },
      { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "체험팩과 24팩 구성은 배송 조건이 다르게 붙을 수 있습니다. 무료배송 여부와 적립, 쿠폰 적용 후 최종 결제 금액을 함께 보는 편이 안전합니다." },
    ],
  },
  {
    brand: "마이밀",
    ...
    productCount: 7,
    events: [
      { category: "쿠폰", periodLabel: "회원 혜택", description: "대상웰라이프 이벤트 목록 기준으로 네이버페이 적립, 웰페이 즉시할인, 신규회원 혜택이 함께 열리는지 확인하세요. 멤버십 쿠폰과 결제수단 혜택 중 무엇이 유리한지 같이 보는 편이 좋습니다." },
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "웰라이프몰 행사 페이지 기준으로 마이밀 프로틴 라인은 기획전 진입가를 먼저 확인할 가치가 있습니다. 대용량 구성은 단품가보다 박스 단가와 배송 조건을 함께 보는 편이 좋습니다." },
    ],
  },
  {
    brand: "얼티브",
    ...
    productCount: 6,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "현재 기준으로 비건 라인업은 CJ더마켓 전체 프로모션과 함께 묶일 때 체감가 차이가 커집니다. 브랜드 할인만 보지 말고 사이트 공통 혜택도 같이 보는 편이 좋습니다." },
  ...
  },
  {
    ...
    productCount: 5,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "현재 기준으로 드링크와 바를 함께 묶는 세트 구성이 반복적으로 노출됩니다. 교차 구매 할인 여부를 먼저 확인하는 편이 좋습니다." },
  ...
  },
  {
    ...
    productCount: 4,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "현재 기준으로 프로틴 드링크·쉐이크 라인 묶음 특가가 붙을 때 체감가 차이가 커집니다. 공식몰 기준가를 먼저 확인하는 편이 좋습니다." },
...
const rawBarBrands: BrandCard[] = [
  ...
  },
  {
    ...
    productCount: 7,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "현재 기준으로 프로 바·바이트·너츠 라인별 묶음 특가가 붙는 경우가 있습니다. 선물용 구성과 일반 구성의 단가 차이도 함께 보는 편이 좋습니다." },
  ...
  },
  {
    ...
    productCount: 4,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "한정 맛이나 시즌 구성은 공식몰 할인 반영이 빠른 편입니다. 신맛 라인 등 한정 구성을 먼저 체크하는 편이 좋습니다." },
  ...
  },
  {
    ...
    productCount: 4,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "묶음팩 할인과 대형몰 기획전이 함께 걸릴 때 단가 차이가 커집니다. 변동이 잦아 주문 직전 판매처별 최종가를 다시 확인하는 편이 좋습니다." },
      { category: "무료배송", periodLabel: "판매처별 상이", description: "대형 유통몰 기준 배송비 조건이 달라 묶음 수량과 배송비 포함 총액을 함께 확인하는 편이 좋습니다." },
    ],
  },
  {
    brand: "비에스엔",
  ...
  },
  {
    ...
    productCount: 3,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "현재 기준으로 크런치바·마일드바 묶음 기획이 자주 보여 단가 차이가 납니다. 장바구니 쿠폰 적용 여부도 같이 보는 편이 좋습니다." },
  ...
  },
  {
    ...
    productCount: 3,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "할인 코드 중심 브랜드라 공식 SNS·뉴스레터에서 현재 코드 노출 여부를 먼저 확인하는 편이 좋습니다. 표기 할인율보다 실결제가가 더 중요합니다." },
  ...
  },
  {
    ...
    productCount: 2,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "이지프로틴 라인은 롯데 계열몰 기획전 반영이 빠른 편입니다. 세트 구성 여부도 같이 확인하는 편이 좋습니다." },
...
const rawShakeBrands: BrandCard[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "자사몰 상품 페이지의 무료배송 기준과 묶음 수량을 함께 확인하세요. 소량 구매보다 묶음 구성에서 체감가 차이가 더 크게 날 수 있습니다." },
    ],
  },
  {
    brand: "단백하니",
    ...
    productCount: 3,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "올리브영 상품 기준으로 단백하니 일부 SKU에 1+1과 오늘드림 배지가 확인됩니다. 브랜드관 진입 후 행사 배지 유지 여부를 먼저 보는 편이 좋습니다." },
      { category: "쿠폰", periodLabel: CHECKED_DATE_LABEL, description: "올리브영은 상품별 행사와 카드 혜택이 동시에 붙을 수 있습니다. 앱 쿠폰, THE CJ 카드 혜택, 오늘드림 적용 여부를 장바구니 단계에서 다시 확인하는 편이 안전합니다." },
    ],
  },
  {
    brand: "프로티원",
    ...
    events: [
      ...
      { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "올리브영은 오늘드림, 일반배송, 무료배송 기준이 SKU별로 달라질 수 있어 배송 방식까지 포함한 최종 결제 조건을 확인하는 편이 안전합니다." },
    ],
  },
  {
    brand: "잇더핏",
  ...
  },
  {
    ...
    events: [
      ...
      { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "네이버 쇼핑 기준 배송비 포함 최종가와 판매처별 쿠폰 적용 여부를 함께 비교하는 편이 좋습니다." },
    ],
  },
];
...
const rawYogurtBrands: BrandCard[] = [
  {
    ...
    productCount: 7,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "멤버십가·정기배송 할인 문구가 함께 노출될 때 체감가 차이가 커집니다. 대용량과 소포장 모두 공식몰 기준가를 먼저 확인하는 편이 좋습니다." },
      { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "회원 30,000원 이상 무료배송 기준이 표시됩니다. 묶음 구매 시 체감가가 더 좋아지는 구조인지 같이 보는 편이 좋습니다." },
    ],
  },
  {
    brand: "YOZM",
    ...
    productCount: 3,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "정기배송 할인 옵션이 상품 페이지에 노출될 때가 있어 450g·800g 대용량은 정기배송 여부까지 같이 보는 편이 좋습니다." },
      { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "30,000원 이상 구매 시 무료배송 기준이 표시됩니다. 현재 신규 쿠폰 노출 여부도 같이 확인하는 편이 좋습니다." },
    ],
  },
  {
    brand: "후디스",
    ...
    productCount: 4,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "회원 할인 판매가와 추가 할인이 함께 노출될 때 체감가 차이가 커집니다. 그릭요거트 라인은 정기배송 할인 여부도 같이 확인하는 편이 좋습니다." },
  ...
  },
  {
    ...
    productCount: 5,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "80g 16개입·2종 구성은 브랜드관 특가 여부에 따라 체감가 차이가 납니다. 특가 구성을 먼저 보는 편이 좋습니다." },
      { category: "쿠폰", periodLabel: CHECKED_DATE_LABEL, description: "브랜드관 쿠폰 노출 여부를 확인하세요. 추가 쿠폰 발급 여부도 같이 보는 편이 좋습니다." },
  ...
  },
  {
    ...
    productCount: 14,
    events: [
      { category: "쿠폰", periodLabel: CHECKED_DATE_LABEL, description: "매일유업 직영몰 웰컴쿠폰과 구매 적립 구조가 함께 노출될 수 있습니다. 신규 회원 조건과 재구매 조건을 같이 보는 편이 좋습니다." },
  ...
  },
  {
    ...
    productCount: 4,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "멤버십 할인 문구와 SALE 배지가 함께 노출될 때가 있습니다. 아이슬란딕 라인은 100g과 450g 가격 차이를 같이 보는 편이 좋습니다." },
      { category: "증정", periodLabel: CHECKED_DATE_LABEL, description: "네이버페이·톡체크아웃 연계 혜택이 붙는지 확인 가치가 있습니다. 현재 증정 이벤트 여부도 같이 보세요." },
    ],
  },
];
...
const additionalBarBrands: BrandCard[] = [
  ...
  { brand: "오늘단백", storeType: "네이버 브랜드관", storeUrl: "https://brand.naver.com/harim/category/1a6d3a6007e143a59ecb3ae9b3418fc2?cp=2", note: "현재 등록 제품 4개", productCount: 4, events: [{ category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "밀크초코 라인 4종은 맛별 세트와 묶음 수량에 따라 단가 차이가 날 수 있습니다." }, { category: "쿠폰", periodLabel: CHECKED_DATE_LABEL, description: "네이버 브랜드관 쿠폰과 적립을 함께 반영하면 체감가가 더 내려갈 수 있습니다." }] },
  ...
  { brand: "씨알로", storeType: "공식 판매처", storeUrl: "https://www.coupang.com/", note: "현재 등록 제품 1개", productCount: 1, events: [{ category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "소수 SKU 중심이라 입점몰 기획전 여부에 따라 가격이 달라집니다." }, { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "판매처별 배송 조건을 포함해 최종 결제 금액을 비교하는 편이 좋습니다." }] },
...
const additionalShakeBrands: BrandCard[] = [
  { brand: "바지오", storeType: "네이버 스토어", storeUrl: "https://smartstore.naver.com/bbagio/category/d890334c286d4920bbc0c2c0eb8ffd11?cp=1", note: "현재 등록 쉐이크 7개", productCount: 7, events: [{ category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "쉐이크얌 7종은 맛별 세트와 스마트스토어 행사 여부에 따라 박스 단가 차이가 큽니다." }, { category: "쿠폰", periodLabel: CHECKED_DATE_LABEL, description: "네이버 스토어 쿠폰과 쿠팡 단품가를 함께 비교하면 구매처별 체감가 차이를 더 쉽게 볼 수 있습니다." }] },
...
const TOTAL_REGISTERED_PRODUCTS =
  [...drinkBrands, ...barBrands, ...yogurtBrands, ...shakeBrands].reduce(
    ...
    <>
      ...
      >
        <div className="mx-auto max-w-[1200px] px-4 py-4 md:px-6 md:py-5">
          <div className="mb-2 inline-flex items-center gap-1.5 rounded-full px-3 py-1" style={{ background: "#FDEDE3", color: "#C2410C" }}>
            <span aria-hidden>🔥</span>
            <span className="text-xs font-bold">지금 확인하는 핫딜</span>
          </div>
      ...
      <main className="mx-auto max-w-[1200px] px-4 pb-12 md:px-6">
          ...
          {(["drink", "bar", "yogurt", "shake"] as const).map((type) => {
            ...
            return (
              <button
                ...
                style={{
                  background: active ? "#16412D" : "#fff",
                  color: active ? "#fff" : "#6b6b6b",
                  border: active ? "1px solid #16412D" : "1px solid var(--border)",
                }}
              >
                {meta.label}
              </button>
        ...
        <p className="mt-10 text-center text-xs leading-5 text-[#8b8b8b]">
          이벤트와 배송 조건은 판매처 정책에 따라 수시로 바뀝니다. 이 페이지는 오늘 확인할 우선순위를 돕기 위한 정리이며,
          최종 결제 전에는 브랜드 공식몰, 네이버 스토어, 쿠팡 로켓배송 페이지에서 혜택 내용을 다시 확인하는 것을 권장합니다.
        </p>
      </main>
    </>
  );
...
function BrandEventCard({ brand, productType }: { brand: BrandCard; productType: ProductType }) {
  ...
  return (
    <div
      className="flex h-full min-h-[284px] flex-col overflow-hidden rounded-2xl border bg-[#fffdf8] shadow-[0_10px_24px_rgba(20,40,28,0.05)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_18px_36px_rgba(28,52,39,0.14)]"
      style={{
      ...
      <div>
        ...
        >
          ...
          <div className="mt-3 flex items-start gap-3">
            <span
              aria-hidden
              className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full text-xl shadow-sm"
