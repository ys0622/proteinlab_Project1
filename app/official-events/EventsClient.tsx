...
const rawShakeBrands: BrandCard[] = [
  {
    brand: "플라이밀",
    storeType: "올리브영",
    storeUrl: "https://www.oliveyoung.co.kr/store/goods/getGoodsDetail.do?goodsNo=B000000226428",
    note: "현재 등록 쉐이크 13개",
    productCount: 13,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "올리브영에서는 플라이밀 단백질 쉐이크 대용량 630g 11종 기준으로 세일가가 자주 바뀌어 현재 적용 중인 할인가를 먼저 보는 편이 좋습니다." },
      { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "업체배송 무료배송 표기가 함께 노출되는 경우가 있어 배송비 포함 최종가를 같이 확인하는 편이 안전합니다." },
    ],
  },
  {
    brand: "랩노쉬",
    storeType: "올리브영 브랜드관",
    storeUrl: "https://www.oliveyoung.co.kr/store/display/getBrandShopDetail.do?onlBrndCd=A001588",
    note: "현재 등록 쉐이크 9개",
    productCount: 9,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "올리브영 브랜드관에서는 슬림쉐이크와 드링크가 함께 노출돼 세일 배지와 올영픽 적용 여부를 같이 보는 편이 좋습니다." },
      { category: "무료배송", periodLabel: CHECKED_DATE_LABEL, description: "오늘드림과 일반배송 조건이 상품마다 달라 한 박스와 묶음 구성의 실제 체감가를 따로 비교하는 편이 안전합니다." },
    ],
  },
  {
    brand: "단백하니",
    ...
    productCount: 3,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "단백하니 쉐이크는 올리브영 브랜드관에서 3종 중심으로 노출돼 올영세일이나 브랜드전 적용 여부를 먼저 보는 편이 좋습니다." },
  ...
  },
  {
    brand: "프로티원",
    storeType: "올리브영 브랜드관",
    storeUrl: "https://www.oliveyoung.co.kr/store/display/getBrandShopDetail.do?onlBrndCd=A010952",
    note: "현재 등록 쉐이크 5개",
    productCount: 5,
    events: [
      { category: "할인", periodLabel: CHECKED_DATE_LABEL, description: "프로티원 브랜드관은 파우치형 1박스, 2박스, 대용량 1통·2통 구성이 함께 보여 단품보다 구성별 체감가를 먼저 비교하는 편이 좋습니다." },
