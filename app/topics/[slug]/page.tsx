    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-[1200px] px-4 pb-12 pt-6 md:px-6">
        <section className="rounded-2xl border border-[#e8e6e3] bg-[#FFFDF8] p-5">
          <h2 className="text-base font-semibold text-[var(--foreground)]">이 페이지에서 볼 수 있는 것</h2>
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-[var(--foreground-muted)]">
                조건형 랜딩에서 설명만 보고 끝나지 않도록 실제 비교 페이지로 바로 연결합니다.
              </p>
            </div>
            <Link
        ...
        <RelatedLinkCards
          title="함께 보면 좋은 페이지"
          description="가이드, 순위, 추천, 카테고리 페이지를 함께 연결해 탐색 경로를 넓혔습니다."
